...
------------------------------------------------------------------
  AGENT-README.txt
      CodeBrix.Plotter.MitLicenseForever — a SkiaSharp-based plotting library:
      build a PlotModel of axes, series, annotations and legends, then render it
      to an SKCanvas or export it to PNG, JPEG, PDF or SVG.
