...
namespace CodeBrix.Plotter.Tests.ExampleLibrary.Utilities; //was previously: ExampleLibrary.Utilities;
...
public static class PlotModelUtilities
{
    ...
    {
        // Upstream listed CandleStickAndVolumeSeries and OldCandleStickSeries
        // here. Both were marked [Obsolete] upstream and are not part of
        // CodeBrix.Plotter, so every remaining XYAxisSeries is transposable.
    };
