...
public static class CustomSeriesExamples
{
    ...
    public static PlotModel FlagSeries()
    {
        ...
        var s1 = new FlagSeries { Title = "Incidents", Color = PlotterColors.Red };
        s1.Values.Add(2);
        s1.Values.Add(3);
        s1.Values.Add(5);
        s1.Values.Add(7);
    ...
    {
        var model = new PlotModel { Title = "Polar heat map", PlotMargins = new PlotterThickness(40, 80, 40, 40), PlotType = PlotType.Polar, PlotAreaBorderThickness = new PlotterThickness(0) };
        ...
        model.Axes.Add(new LinearColorAxis { Position = AxisPosition.Right, Palette = PlotterPalettes.Rainbow(500), HighColor = PlotterColors.Gray, LowColor = PlotterColors.Black });
    ...
    public static PlotModel DesignStructureMatrix()
    {
        ...
        model.Axes.Add(new LinearColorAxis { Position = AxisPosition.None, Palette = new PlotterPalette(PlotterColors.White, PlotterColors.LightGreen), LowColor = PlotterColors.Black, Minimum = 0, IsAxisVisible = false });
