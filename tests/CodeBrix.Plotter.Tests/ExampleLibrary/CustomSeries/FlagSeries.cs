...
public class FlagSeries : ItemsSeries
{
    ...
    /// </summary>
    private PlotterSize symbolSize;
    ...
    public FlagSeries()
    {
        ...
        this.Color = PlotterColors.Black;
        this.FontSize = 10;
    ...
    public override TrackerHitResult GetNearestPoint(ScreenPoint point, bool interpolate)
    {
        foreach (var v in this.Values)
        {
            ...
            var r = new PlotterRect(x - (this.symbolSize.Width / 2), this.symbolPosition - this.symbolSize.Height, this.symbolSize.Width, this.symbolSize.Height);
            if (r.Contains(point))
            {
