...
public class ShowCases
{
    ...
    public static PlotModel LineLegendPositionAtEnd()
    {
        ...
        var model = new PlotModel { Title = "Average (Mean) monthly temperatures in 2003", PlotMargins = new PlotterThickness(60, 4, 60, 40), PlotAreaBorderThickness = new PlotterThickness(0), IsLegendVisible = false };
