...
public class ShowMeTheNumbersExamples
{
    ...
    {
        var pm = new PlotModel { Title = "Q1 2003 Calls by Region", PlotAreaBorderThickness = new PlotterThickness(0) };
        ...
        var series = new BarSeries { FillColor = PlotterColors.Black, XAxisKey = "x", YAxisKey = "y" };
    ...
    public static PlotModel Graph2()
    {
        ...
        var s1 = new LineSeries { Color = PlotterColors.Orange };
        for (int i = 0; i < 12; i++)
        {
            s1.Points.Add(new DataPoint(i, sales1[i]));
        }

        var s2 = new LineSeries { Color = PlotterColors.Gray };
        for (int i = 0; i < 12; i++)
        {
    ...
    public static PlotModel Graph3()
    {
        var pm = new PlotModel
                     {
                         Title = "Headcount",
                         PlotAreaBorderThickness = new PlotterThickness(0),
                         PlotMargins = new PlotterThickness(100, 40, 20, 40)
                     };
        ...
        pm.Series.Add(new BarSeries { FillColor = PlotterColors.Black, ItemsSource = values, ValueField = "Value" });
        return pm;
    }
    ...
    {
        var pm = new PlotModel { Title = "Regional % of Total Expenses", PlotAreaBorderThickness = new PlotterThickness(0) };
        var categoryAxis = new CategoryAxis
        {
            TickStyle = TickStyle.None,
            GapWidth = 0,
        ...
        var series = new BarSeries
                {
                    BarWidth = 1.0,
                    StrokeColor = PlotterColors.DarkGray,
                    StrokeThickness = 1.0,
                    FillColor = PlotterColors.Black,
                    XAxisKey = "x",
                    YAxisKey = "y"
                };
    ...
    {
        var pm = new PlotModel { Title = "Actual to Plan Variance", PlotAreaBorderThickness = new PlotterThickness(0) };
        var values = new Dictionary<string, double>();
        values.Add("Sales", 7);
        ...
        pm.Series.Add(
            new BarSeries
                {
                    FillColor = PlotterColors.Orange,
                    NegativeFillColor = PlotterColors.Gray,
                    ItemsSource = values,
                    ValueField = "Value",
                    XAxisKey = "x",
                    YAxisKey = "y"
    ...
    public static PlotModel Graph6()
    {
        var pm = new PlotModel
                     {
                         ...
                         PlotAreaBorderThickness = new PlotterThickness(0),
                         PlotMargins = new PlotterThickness(60, 4, 4, 60)
                     };
        var values = new Dictionary<string, double>
            {
                { " <$10", 5000 },
        ...
        pm.Series.Add(new BarSeries { FillColor = PlotterColors.Orange, ItemsSource = values, ValueField = "Value", XAxisKey = "x", YAxisKey = "y" });
        return pm;
    }
            ...
            new ScatterSeries
                {
                    ...
                    MarkerSize = 3.0,
                    MarkerFill = PlotterColors.White,
