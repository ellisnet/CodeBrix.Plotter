...
public class AxisExamples
{
    ...
    public static PlotModel TickLineColor()
    {
        ...
        plotModel1.Axes.Add(new LinearAxis
        {
            ...
            TicklineColor = PlotterColors.Blue,
            MinorTicklineColor = PlotterColors.Gray,
        });
        plotModel1.Axes.Add(new LinearAxis
        {
    ...
    {
        var plotModel1 = new PlotModel { PlotMargins = new PlotterThickness(60, 40, 60, 30) };
        plotModel1.Axes.Add(new LinearAxis
        {
            Angle = 45,
            MajorGridlineStyle = LineStyle.Solid,
    ...
    public static PlotModel Defaultpadding()
    {
        ...
        {
            Color = PlotterColor.FromArgb(255, 78, 154, 6),
            MarkerFill = PlotterColor.FromArgb(255, 78, 154, 6)
        };
    ...
    public static PlotModel GraphPaper()
    {
        ...
        model.Axes.Add(
            new LinearAxis
            {
                ...
                MajorGridlineColor = PlotterColor.FromAColor(40, c),
                MinorGridlineColor = PlotterColor.FromAColor(20, c)
            });
        model.Axes.Add(
            new LinearAxis
            {
    ...
    public static PlotModel OnBlack()
    {
        var model = new PlotModel
        {
            ...
            Background = PlotterColors.Black,
            TextColor = PlotterColors.White,
            PlotAreaBorderColor = PlotterColors.White
        };
        var c = PlotterColors.White;
        model.PlotType = PlotType.Cartesian;
        ...
        model.Axes.Add(
            new LinearAxis
            {
                ...
                MajorGridlineColor = PlotterColor.FromAColor(40, c),
                MinorGridlineColor = PlotterColor.FromAColor(20, c),
                TicklineColor = PlotterColors.White
            });
        model.Axes.Add(
            new LinearAxis
            {
    ...
    public static PlotModel Backgrounds()
    {
        var model = new PlotModel
        {
            ...
            Background = PlotterColors.Silver,
            PlotAreaBackground = PlotterColors.Gray,
            PlotAreaBorderColor = PlotterColors.Black,
            PlotAreaBorderThickness = new PlotterThickness(3)
        };
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Bottom });
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Left });
        return model;
    ...
    public static PlotModel TitleColor()
    {
        ...
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Bottom, Minimum = -1, Maximum = 1, Title = "Bottom axis", TitleColor = PlotterColors.Red });
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Left, Minimum = -1, Maximum = 1, Title = "Left axis", TitleColor = PlotterColors.Blue });
        model.Series.Add(new FunctionSeries(Math.Sin, -1, 1, 100));
        return model;
    }
    ...
    public static PlotModel LabelColor()
    {
        ...
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Bottom, Minimum = -1, Maximum = 1, Title = "Bottom axis", TextColor = PlotterColors.Red });
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Left, Minimum = -1, Maximum = 1, Title = "Left axis", TextColor = PlotterColors.Blue });
        model.Series.Add(new FunctionSeries(Math.Sin, -1, 1, 100));
        return model;
    }
    ...
    public static PlotModel GridlineCroppingBoth()
    {
        ...
        plotModel1.Axes.Add(new LinearAxis
        {
            ...
            ExtraGridlineColor = PlotterColors.Red,
            StartPosition = 0.1,
            EndPosition = 0.4,
            CropGridlines = true
        });
    ...
    public static PlotModel MultiVerticalAxes()
    {
        ...
        Legend l = new Legend
        {
            LegendBackground = PlotterColors.White
        };
        ...
        // Initialization lineSeries pressure
        {
            ...
            {
                Title = "Pressure",
                Color = PlotterColors.Peru,
                LineStyle = LineStyle.Solid,
                MarkerType = MarkerType.Circle,
                MarkerSize = 3,
                MarkerFill = PlotterColors.Sienna,
        ...
        // Initialization lineSeries humidity
        {
            ...
            {
                Title = "Humidity",
                Color = PlotterColors.LightSkyBlue,
                LineStyle = LineStyle.Solid,
                MarkerType = MarkerType.Circle,
                MarkerSize = 3,
                MarkerFill = PlotterColors.DeepSkyBlue,
    ...
    {
        var plotModel = new PlotModel() { Title = "Manual Margins", Subtitle = "PlotMargins = 40", PlotMargins = new PlotterThickness(40) };
    ...
    {
        var plotModel = new PlotModel() { Title = "Manual Left Margin", Subtitle = "PlotMargins = 40,NaN,NaN,NaN", PlotMargins = new PlotterThickness(40, double.NaN, double.NaN, double.NaN) };
        plotModel.Axes.Add(new LinearAxis() { Position = AxisPosition.Bottom });
        return plotModel;
    }
    ...
    public static PlotModel MarginsAndPadding()
    {
        ...
        rectangle.Color = PlotterColors.Green;
        ...
        plot.Annotations.Add(new RenderingCapabilities.DelegateAnnotation(rc =>
        {
            foreach (var axis in plot.Axes)
            {
                if (axis.IsHorizontal())
                {
                    ...
                    rc.DrawLine(h.Transform(h.ClipMinimum), 0.0, h.Transform(h.ClipMinimum), plot.Height, new PlotterPen(PlotterColors.Blue, 1, LineStyle.Dot), EdgeRenderingMode.Automatic);
                    rc.DrawLine(h.Transform(h.ClipMaximum), 0.0, h.Transform(h.ClipMaximum), plot.Height, new PlotterPen(PlotterColors.Blue, 1, LineStyle.Dot), EdgeRenderingMode.Automatic);

                    rc.DrawLine(h.Transform(h.ActualMinimum), 0.0, h.Transform(h.ActualMinimum), plot.Height, new PlotterPen(PlotterColors.Red, 1, LineStyle.Dot), EdgeRenderingMode.Automatic);
                    rc.DrawLine(h.Transform(h.ActualMaximum), 0.0, h.Transform(h.ActualMaximum), plot.Height, new PlotterPen(PlotterColors.Red, 1, LineStyle.Dot), EdgeRenderingMode.Automatic);

                    rc.DrawLine(h.Transform(h.DataMinimum), 0.0, h.Transform(h.DataMinimum), plot.Height, new PlotterPen(PlotterColors.Green, 1, LineStyle.Dot), EdgeRenderingMode.Automatic);
                    rc.DrawLine(h.Transform(h.DataMaximum), 0.0, h.Transform(h.DataMaximum), plot.Height, new PlotterPen(PlotterColors.Green, 1, LineStyle.Dot), EdgeRenderingMode.Automatic);
                }
                else
                {
                    var v = axis;

                    rc.DrawLine(0.0, v.Transform(v.ClipMinimum), plot.Width, v.Transform(v.ClipMinimum), new PlotterPen(PlotterColors.Blue, 1, LineStyle.Dot), EdgeRenderingMode.Automatic);
                    rc.DrawLine(0.0, v.Transform(v.ClipMaximum), plot.Width, v.Transform(v.ClipMaximum), new PlotterPen(PlotterColors.Blue, 1, LineStyle.Dot), EdgeRenderingMode.Automatic);

                    rc.DrawLine(0.0, v.Transform(v.ActualMinimum), plot.Width, v.Transform(v.ActualMinimum), new PlotterPen(PlotterColors.Red, 1, LineStyle.Dot), EdgeRenderingMode.Automatic);
                    rc.DrawLine(0.0, v.Transform(v.ActualMaximum), plot.Width, v.Transform(v.ActualMaximum), new PlotterPen(PlotterColors.Red, 1, LineStyle.Dot), EdgeRenderingMode.Automatic);

                    rc.DrawLine(0.0, v.Transform(v.DataMinimum), plot.Width, v.Transform(v.DataMinimum), new PlotterPen(PlotterColors.Green, 1, LineStyle.Dot), EdgeRenderingMode.Automatic);
                    rc.DrawLine(0.0, v.Transform(v.DataMaximum), plot.Width, v.Transform(v.DataMaximum), new PlotterPen(PlotterColors.Green, 1, LineStyle.Dot), EdgeRenderingMode.Automatic);
                }
            }
        }));
    }
