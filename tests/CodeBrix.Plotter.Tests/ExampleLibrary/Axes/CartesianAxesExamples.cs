...
public class CartesianAxesExamples
{
    ...
    public static PlotModel AbsoluteYmin()
    {
        ...
        plot.Axes.Add(new LinearAxis { Position = AxisPosition.Bottom, Title = "X-axis", MajorGridlineStyle = LineStyle.Solid, MinorGridlineStyle = LineStyle.Solid, MajorGridlineColor = PlotterColor.FromAColor(40, c), MinorGridlineColor = PlotterColor.FromAColor(20, c) });
        plot.Axes.Add(new LinearAxis { Position = AxisPosition.Left, Title = "Y-axis", AbsoluteMinimum = 0, Minimum = 0, MajorGridlineStyle = LineStyle.Solid, MinorGridlineStyle = LineStyle.Solid, MajorGridlineColor = PlotterColor.FromAColor(40, c), MinorGridlineColor = PlotterColor.FromAColor(20, c) });
    ...
    public static PlotModel AbsoluteYmin2()
    {
        var plot = new PlotModel
        {
            ...
            PlotMargins = new PlotterThickness(60, 4, 4, 40)
        };
        var c = PlotterColors.DarkBlue;
        plot.Axes.Add(new LinearAxis { Position = AxisPosition.Bottom, Title = "X-axis", MajorGridlineStyle = LineStyle.Solid, MinorGridlineStyle = LineStyle.Solid, MajorGridlineColor = PlotterColor.FromAColor(40, c), MinorGridlineColor = PlotterColor.FromAColor(20, c) });
        plot.Axes.Add(new LinearAxis { Position = AxisPosition.Left, Title = "Y-axis", AbsoluteMinimum = 0, Minimum = 0, MajorGridlineStyle = LineStyle.Solid, MinorGridlineStyle = LineStyle.Solid, MajorGridlineColor = PlotterColor.FromAColor(40, c), MinorGridlineColor = PlotterColor.FromAColor(20, c) });
    ...
    public static PlotModel AbsoluteYminXmin()
    {
        ...
        var c = PlotterColors.DarkBlue;
        plot.Axes.Add(new LinearAxis { Position = AxisPosition.Bottom, Title = "X-axis", AbsoluteMinimum = -10, MajorGridlineStyle = LineStyle.Solid, MinorGridlineStyle = LineStyle.Solid, MajorGridlineColor = PlotterColor.FromAColor(40, c), MinorGridlineColor = PlotterColor.FromAColor(20, c) });
        plot.Axes.Add(new LinearAxis { Position = AxisPosition.Left, Title = "Y-axis", AbsoluteMinimum = 0, Minimum = 0, MajorGridlineStyle = LineStyle.Solid, MinorGridlineStyle = LineStyle.Solid, MajorGridlineColor = PlotterColor.FromAColor(40, c), MinorGridlineColor = PlotterColor.FromAColor(20, c) });
        plot.Series.Add(CreateTestSeries());
        return plot;
    }
    ...
    public static PlotModel AbsoluteYminYmax()
    {
        ...
        var c = PlotterColors.DarkBlue;
        plot.Axes.Add(new LinearAxis { Position = AxisPosition.Bottom, Title = "X-axis", MajorGridlineStyle = LineStyle.Solid, MinorGridlineStyle = LineStyle.Solid, MajorGridlineColor = PlotterColor.FromAColor(40, c), MinorGridlineColor = PlotterColor.FromAColor(20, c) });
        plot.Axes.Add(new LinearAxis { Position = AxisPosition.Left, Title = "Y-axis", AbsoluteMinimum = 0, Minimum = 0, AbsoluteMaximum = 2, MajorGridlineStyle = LineStyle.Solid, MinorGridlineStyle = LineStyle.Solid, MajorGridlineColor = PlotterColor.FromAColor(40, c), MinorGridlineColor = PlotterColor.FromAColor(20, c) });
        plot.Series.Add(CreateTestSeries());
        return plot;
    }
    ...
    public static PlotModel AbsoluteYminXminXmax()
    {
        ...
        var c = PlotterColors.DarkBlue;
        plot.Axes.Add(new LinearAxis { Position = AxisPosition.Bottom, Title = "X-axis", AbsoluteMinimum = -10, AbsoluteMaximum = 10, MajorGridlineStyle = LineStyle.Solid, MinorGridlineStyle = LineStyle.Solid, MajorGridlineColor = PlotterColor.FromAColor(40, c), MinorGridlineColor = PlotterColor.FromAColor(20, c) });
        plot.Axes.Add(new LinearAxis { Position = AxisPosition.Left, Title = "Y-axis", AbsoluteMinimum = 0, Minimum = 0, MajorGridlineStyle = LineStyle.Solid, MinorGridlineStyle = LineStyle.Solid, MajorGridlineColor = PlotterColor.FromAColor(40, c), MinorGridlineColor = PlotterColor.FromAColor(20, c) });
        plot.Series.Add(CreateTestSeries());
    ...
    private static CodeBrix.Plotter.Series.Series CreateTestSeries()
    {
