...
public static class LogarithmicAxisExamples
{
    ...
    public static PlotModel RichterMagnitudes()
    {
        ...
        var model = new PlotModel
        {
            ...
            PlotMargins = new PlotterThickness(80, 0, 80, 40),
        };
        ...
        {
            Title = "Frequency",
            Color = PlotterColor.FromUInt32(0xff3c6c9e),
            StrokeThickness = 3,
            MarkerStroke = PlotterColor.FromUInt32(0xff3c6c9e),
        ...
        {
            Title = "Energy",
            Color = PlotterColor.FromUInt32(0xff9e6c3c),
            StrokeThickness = 3,
            MarkerStroke = PlotterColor.FromUInt32(0xff9e6c3c),
            MarkerFill = PlotterColors.White,
            MarkerType = MarkerType.Circle,
            MarkerSize = 4,
            MarkerStrokeThickness = 3
