...
public static class XkcdExamples
{
    ...
    public static PlotModel Test2()
    {
        ...
        {
            Color = PlotterColors.Cyan,
            StrokeThickness = 4,
        };

        var s2 = new LineSeries
        {
            Color = PlotterColors.White,
            StrokeThickness = 14,
        };
    ...
    public static PlotModel Test3()
    {
        ...
        model.Legends.Add(l);
        var s1 = new BarSeries { Title = "Series 1", IsStacked = false, StrokeColor = PlotterColors.Black, StrokeThickness = 1, XAxisKey = "x", YAxisKey = "y" };
        s1.Items.Add(new BarItem { Value = 25 });
        s1.Items.Add(new BarItem { Value = 137 });
        s1.Items.Add(new BarItem { Value = 18 });
        s1.Items.Add(new BarItem { Value = 40 });

        var s2 = new BarSeries { Title = "Series 2", IsStacked = false, StrokeColor = PlotterColors.Black, StrokeThickness = 1, XAxisKey = "x", YAxisKey = "y" };
