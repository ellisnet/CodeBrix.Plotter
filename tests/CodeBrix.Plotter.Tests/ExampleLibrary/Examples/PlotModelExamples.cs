...
public static class PlotModelExamples
{
    ...
    {
        var model = new PlotModel { Title = "Background = Undefined", Background = PlotterColors.Undefined };
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Bottom });
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Left });
        return model;
    }
    ...
    {
        var model = new PlotModel { Title = "Background = 50% White", Background = PlotterColor.FromAColor(128, PlotterColors.White) };
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Bottom });
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Left });
        return model;
    }
    ...
    {
        var model = new PlotModel { Title = "Background = Transparent", Background = PlotterColors.Transparent };
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Bottom });
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Left });
        return model;
    }
    ...
    {
        var model = new PlotModel { Title = "Background = LightSkyBlue", Background = PlotterColors.LightSkyBlue };
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Bottom });
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Left });
        return model;
    }
    ...
    {
        var model = new PlotModel { Title = "Background = White", Background = PlotterColors.White };
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Bottom });
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Left });
        return model;
    }
    ...
    {
        var model = new PlotModel { Title = "Background = Black", Background = PlotterColors.Black, TextColor = PlotterColors.White, TitleColor = PlotterColors.White, PlotAreaBorderColor = PlotterColors.White };
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Bottom, TicklineColor = PlotterColors.White });
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Left, TicklineColor = PlotterColors.White });
        return model;
    }
    ...
    {
        var model = new PlotModel { Title = "PlotAreaBorderThickness = 2", PlotAreaBorderThickness = new PlotterThickness(2) };
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Bottom });
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Left });
        return model;
    }
    ...
    {
        var model = new PlotModel { Title = "PlotAreaBorderThickness = (1,0,0,1)", PlotAreaBorderThickness = new PlotterThickness(1, 0, 0, 1) };
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Bottom });
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Left });
        return model;
    }
    ...
    {
        var model = new PlotModel { Title = "PlotAreaBorderThickness = (4,1,1,4)", PlotAreaBorderThickness = new PlotterThickness(4, 1, 1, 4) };
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Bottom });
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Left });
        return model;
    }
    ...
    {
        var model = new PlotModel { Title = "PlotAreaBorderThickness = 0", PlotAreaBorderThickness = new PlotterThickness(0) };
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Bottom });
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Left });
        return model;
    }
    ...
    {
        var model = new PlotModel { Title = "PlotAreaBorderThickness = 0", Subtitle = "AxislineThickness = 1, AxislineColor = PlotterColors.Blue, AxislineStyle = LineStyle.Solid", PlotAreaBorderThickness = new PlotterThickness(0) };
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Bottom, AxislineThickness = 1, AxislineColor = PlotterColors.Blue, AxislineStyle = LineStyle.Solid });
        model.Axes.Add(new LinearAxis { Position = AxisPosition.Left, AxislineThickness = 1, AxislineColor = PlotterColors.Blue, AxislineStyle = LineStyle.Solid });
        return model;
    }
    ...
    public static PlotModel ExceptionClipping()
    {
        ...
        {
            rc.PushClip(new PlotterRect(50, 50, 50, 50));
