...
public static class TrackerExamples
{
    ...
    public static Example TrackerFiresDistance()
    {
        ...
        plotController.BindMouseDown(
            PlotterMouseButton.Left,
            new DelegatePlotCommand<PlotterMouseDownEventArgs>((view, controller, args) =>
        ...
        plotController.BindTouchDown(
            new DelegatePlotCommand<PlotterTouchEventArgs>((view, controller, args) =>
