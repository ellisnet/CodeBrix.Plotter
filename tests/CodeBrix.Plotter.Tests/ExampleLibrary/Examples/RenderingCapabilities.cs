...
public class RenderingCapabilities
{
    ...
    public static PlotModel DrawTextColors()
    {
        ...
        model.Annotations.Add(new DelegateAnnotation(rc =>
        {
            ...
            rc.DrawText(new ScreenPoint(X, y += D), "Black", PlotterColors.Black, Font, FontSize, FontWeight);
            rc.DrawText(new ScreenPoint(X, y += D), "Red", PlotterColors.Red, Font, FontSize, FontWeight);
            rc.DrawText(new ScreenPoint(X, y += D), "Green", PlotterColors.Green, Font, FontSize, FontWeight);
            rc.DrawText(new ScreenPoint(X, y += D), "Blue", PlotterColors.Blue, Font, FontSize, FontWeight);

            rc.FillRectangle(new PlotterRect(X, y + D + 15, 200, 10), PlotterColors.Black, EdgeRenderingMode.Adaptive);
            rc.DrawText(new ScreenPoint(X, y + D), "Yellow 50%", PlotterColor.FromAColor(128, PlotterColors.Yellow), Font, FontSize, FontWeight);
        }));
        return model;
    }
    ...
    public static PlotModel DrawTextFonts()
    {
        ...
        model.Annotations.Add(new DelegateAnnotation(rc =>
        {
            ...
            rc.DrawText(new ScreenPoint(X, y += D), "Default font", PlotterColors.Black, null, FontSize);
            rc.DrawText(new ScreenPoint(X, y += D), "Helvetica", PlotterColors.Black, "Helvetica", FontSize);
            rc.DrawText(new ScreenPoint(X, y += D), "Arial", PlotterColors.Black, "Arial", FontSize);
            rc.DrawText(new ScreenPoint(X, y += D), "Courier", PlotterColors.Black, "Courier", FontSize);
            rc.DrawText(new ScreenPoint(X, y += D), "Courier New", PlotterColors.Black, "Courier New", FontSize);
            rc.DrawText(new ScreenPoint(X, y += D), "Times", PlotterColors.Black, "Times", FontSize);
            rc.DrawText(new ScreenPoint(X, y + D), "Times New Roman", PlotterColors.Black, "Times New Roman", FontSize);
        }));
        return model;
    }
    ...
    public static PlotModel DrawTextFontSizes()
    {
        ...
        model.Annotations.Add(new DelegateAnnotation(rc =>
        {
            ...
            {
                rc.DrawText(new ScreenPoint(X, y), size + "pt", PlotterColors.Black, "Arial", size);
                rc.DrawText(new ScreenPoint(X + 200, y), size + "pt", PlotterColors.Black, "Arial", size, FontWeights.Bold);
                y += size * 1.6;
            }
        }));
        return model;
    ...
    public static PlotModel DrawTextRotation()
    {
        ...
        model.Annotations.Add(new DelegateAnnotation(rc =>
        {
            ...
            rc.FillCircle(origin, 3, PlotterColors.Blue, EdgeRenderingMode.Adaptive);
            for (int rotation = 0; rotation < 360; rotation += 45)
            {
                rc.DrawText(origin, string.Format("Rotation {0}", rotation), PlotterColors.Black, fontSize: 20d, rotation: rotation);
            }
        }));
        return model;
    }
        ...
        model.Annotations.Add(new DelegateAnnotation(rc =>
        {
            ...
            for (var ha = HorizontalAlignment.Left; ha <= HorizontalAlignment.Right; ha++)
            {
                for (var va = VerticalAlignment.Top; va <= VerticalAlignment.Bottom; va++)
                {
                    ...
                    rc.FillCircle(origin, 3, PlotterColors.Blue, EdgeRenderingMode.Adaptive);
                    rc.DrawText(origin, ha + "-" + va, PlotterColors.Black, fontSize: FontSize, horizontalAlignment: ha, verticalAlignment: va);
                }
            }
        }));
        return model;
        ...
        model.Annotations.Add(new DelegateAnnotation(rc =>
        {
            ...
            for (var ha = HorizontalAlignment.Left; ha <= HorizontalAlignment.Right; ha++)
            {
                for (var va = VerticalAlignment.Top; va <= VerticalAlignment.Bottom; va++)
                {
                    ...
                    rc.FillCircle(origin, 3, PlotterColors.Blue, EdgeRenderingMode.Adaptive);
                    rc.DrawText(origin, ha + "\r\n" + va, PlotterColors.Black, fontSize: FontSize, horizontalAlignment: ha, verticalAlignment: va);
                }
            }
        }));
        return model;
    ...
    public static PlotModel MathTextRotation()
    {
        ...
        model.Annotations.Add(new DelegateAnnotation(rc =>
        {
            ...
            {
                var text = "     A_{2}^{3}B";
                rc.DrawMathText(origin, text, PlotterColors.Black, fontFamily, fontSize, fontWeight, rotation, HorizontalAlignment.Left, VerticalAlignment.Middle);
                ...
                rc.DrawPolygon(outline1, PlotterColors.Undefined, PlotterColors.Blue, 1, EdgeRenderingMode.Adaptive);

                // Compare with normal text
                var text2 = "     A B";
                rc.DrawText(origin2, text2, PlotterColors.Red, fontFamily, fontSize, fontWeight, rotation, HorizontalAlignment.Left, VerticalAlignment.Middle);
                ...
                rc.DrawPolygon(outline2, PlotterColors.Undefined, PlotterColors.Blue, 1, EdgeRenderingMode.Adaptive);
            }
        }));
        return model;
    }
        ...
        model.Annotations.Add(new DelegateAnnotation(rc =>
        {
            ...
            for (var ha = HorizontalAlignment.Left; ha <= HorizontalAlignment.Right; ha++)
            {
                for (var va = VerticalAlignment.Top; va <= VerticalAlignment.Bottom; va++)
                {
                    var origin = new ScreenPoint((((int)ha + 1) * 200) + 20, (((int)va + 1) * FontSize * 3) + 20);
                    rc.FillCircle(origin, 3, PlotterColors.Blue, EdgeRenderingMode.Adaptive);
                    rc.DrawMathText(origin, text, PlotterColors.Black, FontFamily, FontSize, FontWeight, 0, ha, va);
                }
            }
        }));
        return model;
        ...
        model.Annotations.Add(new DelegateAnnotation(rc =>
        {
            for (var ha = HorizontalAlignment.Left; ha <= HorizontalAlignment.Right; ha++)
            {
                for (var va = VerticalAlignment.Top; va <= VerticalAlignment.Bottom; va++)
                {
                    ...
                    {
                        rc.DrawText(origin, string.Format("R{0:000}", rotation), PlotterColors.Black, fontSize: 20d, rotation: rotation, horizontalAlignment: ha, verticalAlignment: va);
                    }
                }
            }
        }));
        ...
        model.Annotations.Add(new DelegateAnnotation(rc =>
        {
            for (var ha = HorizontalAlignment.Left; ha <= HorizontalAlignment.Right; ha++)
            {
                for (var va = VerticalAlignment.Top; va <= VerticalAlignment.Bottom; va++)
                {
                    ...
                    {
                        rc.DrawText(origin, $"R{rotation:000}\n{ha}\n{va}", PlotterColors.Black, fontSize: 20d, rotation: rotation, horizontalAlignment: ha, verticalAlignment: va);
                    }
                }
            }
        }));
        ...
        model.Annotations.Add(new DelegateAnnotation(rc =>
            {
                ...
                const double X2 = 200;
                double y = 20;
                var testStrings = new[] { "iii", "jjj", "CodeBrix.Plotter", "Bottom", "100", "KML" };
                foreach (var text in testStrings)
                {
                    var maxSize = rc.MeasureText(text, Font, FontSize, FontWeight);
                    var p = new ScreenPoint(X, y);
                    rc.DrawText(p, text, PlotterColors.Black, Font, FontSize, FontWeight, maxSize: maxSize);
                    var rect = new PlotterRect(p, maxSize);
                    rc.DrawRectangle(rect, PlotterColors.Undefined, PlotterColors.Black, 1, EdgeRenderingMode.Adaptive);

                    var p2 = new ScreenPoint(X2, y);
                    var maxSize2 = new PlotterSize(maxSize.Width / 2, maxSize.Height / 2);
                    rc.DrawText(p2, text, PlotterColors.Black, Font, FontSize, FontWeight, maxSize: maxSize2);
                    var rect2 = new PlotterRect(p2, maxSize2);
                    rc.DrawRectangle(rect2, PlotterColors.Undefined, PlotterColors.Black, 1, EdgeRenderingMode.Adaptive);
    ...
    {
        return DrawTextWithMetrics("CodeBrix.Plotter", "Arial", 60, 226, 69, 105, 73, 61, 116, 23, 228, "WPF");
    }
    ...
    {
        return DrawTextWithMetrics("CodeBrix.Plotter", "Arial", 60, 252.145812988281, 79.4999847412109, 108, 73, 61, 121, 34, 252, "WinForms");
    }
    ...
    {
        return DrawTextWithMetrics("CodeBrix.Plotter", "Arial", 60, 224.1, 71.5, 108, 73, 61, 121, 23, 242, "WinForms");
    }
    ...
    public static PlotModel MeasureText()
    {
        ...
        {
            const string Font = "Arial";
            var strings = new[] { "CodeBrix.Plotter", "MMM", "III", "jikq", "gh", "123", "!#$&" };
            ...
            foreach (double fontSize in fontSizes)
            {
                ...
                foreach (var s in strings)
                {
                    ...
                    rc.DrawRectangle(new PlotterRect(x, y, size.Width, size.Height), PlotterColors.LightYellow, PlotterColors.Black, 1, EdgeRenderingMode.Adaptive);
                    rc.DrawText(new ScreenPoint(x, y), s, PlotterColors.Black, Font, fontSize);
                    y += size.Height + 20;
                }
        ...
        model.Annotations.Add(
            new DelegateAnnotation(
                rc =>
                {
                    ...
                    var expectedSize = new PlotterSize(expectedWidth, expectedHeight);
                    rc.DrawText(new ScreenPoint(300, 50), "Font size: " + fontSize, PlotterColors.Black, font, 12);
                    rc.DrawText(new ScreenPoint(300, 70), "Actual size: " + size.ToString("0.00", CultureInfo.InvariantCulture), PlotterColors.Black, font, 12);
                    rc.DrawText(new ScreenPoint(300, 90), "Size on " + platform + ": " + expectedSize.ToString("0.00", CultureInfo.InvariantCulture), PlotterColors.Green, font, 12);

                    var p = new ScreenPoint(20, 50);
                    rc.DrawText(p, text, PlotterColors.Black, font, fontSize);

                    rc.FillCircle(p, 3, PlotterColors.Black, EdgeRenderingMode.Adaptive);

                    // actual bounds
                    rc.DrawRectangle(new PlotterRect(p, size), PlotterColors.Undefined, PlotterColors.Black, 1, EdgeRenderingMode.Adaptive);

                    // Expected bounds (WPF)
                    rc.DrawRectangle(new PlotterRect(p, expectedSize), PlotterColors.Undefined, PlotterColors.Green, 1, EdgeRenderingMode.Adaptive);

                    var color = PlotterColor.FromAColor(180, PlotterColors.Red);
                    var pen = new PlotterPen(color);
    ...
    public static PlotModel Clipping()
    {
        ...
        model.Annotations.Add(new DelegateAnnotation(rc =>
        {
            void DrawClipRect(PlotterRect clipRect)
            {
                var pen = new PlotterPen(PlotterColors.Black, 2, LineStyle.Dash);
            ...
            var rect = new PlotterRect();

            void DrawCircle(ScreenPoint center)
            {
                rc.DrawCircle(center, clipRectSize * 0.58, PlotterColors.CornflowerBlue, PlotterColors.Undefined, 0, EdgeRenderingMode.Automatic);
            }
            ...
            void DrawDescription(string text)
            {
                ...
                rc.DrawText(p, text, PlotterColors.Black, fontSize: 12, verticalAlignment: VerticalAlignment.Middle);
            }
            ...
            {
                rc.DrawText(new ScreenPoint(offset, 15), text, PlotterColors.Black, fontSize: 12, fontWeight: 700);
            }

            void NextLine()
            {
                currentLine += lineHeight;
                rect = new PlotterRect(clipRectMargin, currentLine - clipRectSize / 2, clipRectSize, clipRectSize);
            }
            ...
            //-------------
            NextLine();
            var rect2 = rect.Deflate(new PlotterThickness(rect.Height * 0.25));
            rc.PushClip(rect);
            rc.PushClip(rect2);
            ...
            //-------------
            NextLine();
            rect2 = rect.Deflate(new PlotterThickness(rect.Height * 0.25));
            rc.PushClip(rect2);
            rc.PushClip(rect);
            ...
            //-------------
            NextLine();
            rect2 = rect.Offset(rect.Width / 2, rect.Height / 2).Deflate(new PlotterThickness(rect.Height * 0.25));
            rc.PushClip(rect);
            rc.PushClip(rect2);
            ...
            //-------------
            NextLine();
            var rect3 = rect.Offset(rect.Width / 3, rect.Height / 3).Deflate(new PlotterThickness(rect.Height * 0.25));
            var rect4 = rect.Offset(-rect.Width / 3, -rect.Height / 3).Deflate(new PlotterThickness(rect.Height * 0.25));
            rc.PushClip(rect3);
            rc.PushClip(rect4);
            ...
            {
                rc.DrawText(rect.Center, "CodeBrix.Plotter", PlotterColors.CornflowerBlue, fontSize: 15, horizontalAlignment: HorizontalAlignment.Center, verticalAlignment: VerticalAlignment.Middle);
            }
    ...
    private static readonly PlotterColor FILL_COLOR = PlotterColors.LightBlue;
    ...
    public static PlotModel Rectangles()
    {
        ...
        model.Annotations.Add(new DelegateAnnotation(rc =>
        {
            for (int i = 0; i < THICKNESS_STEPS; i++)
            {
                ...
                rc.DrawText(new ScreenPoint(left, OFFSET_TOP / 2), strokeThickness.ToString(), PlotterColors.Black, horizontalAlignment: HorizontalAlignment.Center, verticalAlignment: VerticalAlignment.Middle);
            }
            ...
            foreach (EdgeRenderingMode edgeRenderingMode in Enum.GetValues(typeof(EdgeRenderingMode)))
            {
                ...
                rc.DrawText(new ScreenPoint(10, top + 10), edgeRenderingMode.ToString(), PlotterColors.Black, verticalAlignment: VerticalAlignment.Middle);
                for (int i = 0; i < THICKNESS_STEPS; i++)
                {
                    var left = OFFSET_LEFT + i * GRID_SIZE;
                    var rect = new PlotterRect(left, top, TILE_SIZE, TILE_SIZE);
                    var strokeThickness = i * THICKNESS_STEP;
                    rc.DrawRectangle(rect, FILL_COLOR, PlotterColors.Black, strokeThickness, edgeRenderingMode);
                }
            }
        ...
        model.Annotations.Add(new DelegateAnnotation(rc =>
        {
            ...
            foreach (EdgeRenderingMode edgeRenderingMode in Enum.GetValues(typeof(EdgeRenderingMode)))
            {
                ...
                for (int i = 0; i < THICKNESS_STEPS; i++)
                {
                    ...
                    rc.DrawLine(new[] { bottomLeft, topLeft, topRight }, PlotterColors.Black, strokeThickness, edgeRenderingMode);
                    rc.DrawLine(new[] { middleLeft, bottomRight, topLeft }, PlotterColors.Black, strokeThickness, edgeRenderingMode, lineJoin: LineJoin.Bevel);
                }
            }
        ...
        model.Annotations.Add(new DelegateAnnotation(rc =>
        {
            ...
            foreach (EdgeRenderingMode edgeRenderingMode in Enum.GetValues(typeof(EdgeRenderingMode)))
            {
                ...
                for (int i = 0; i < THICKNESS_STEPS; i++)
                {
                    ...
                    var strokeThickness = i * THICKNESS_STEP;
                    rc.DrawPolygon(points, FILL_COLOR, PlotterColors.Black, strokeThickness, edgeRenderingMode);
                }
            }
    ...
    public static PlotModel Ellipses()
    {
        ...
        model.Annotations.Add(new DelegateAnnotation(rc =>
        {
            ...
            foreach (EdgeRenderingMode edgeRenderingMode in Enum.GetValues(typeof(EdgeRenderingMode)))
            {
                ...
                {
                    var left = OFFSET_LEFT + i * GRID_SIZE;
                    var rect = new PlotterRect(left, top + TILE_SIZE * .1, TILE_SIZE, TILE_SIZE * .8);
                    var strokeThickness = i * THICKNESS_STEP;
                    rc.DrawEllipse(rect, FILL_COLOR, PlotterColors.Black, strokeThickness, edgeRenderingMode);
                }
            }
    ...
    public static PlotModel LineJoins()
    {
        ...
        model.Annotations.Add(new DelegateAnnotation(rc =>
        {
            ...
            foreach (LineJoin lineJoin in Enum.GetValues(typeof(LineJoin)))
            {
                ...
                rc.DrawText(p, lineJoin.ToString(), PlotterColors.Black, fontSize: 12, horizontalAlignment: HorizontalAlignment.Center, verticalAlignment: VerticalAlignment.Middle);
                colCounter++;
            }
            ...
            foreach (var angle in ANGLES)
            {
                ...
                rc.DrawText(textP, angle.ToString() + "°", PlotterColors.Black, fontSize: 12);
                ...
                foreach (LineJoin lineJoin in Enum.GetValues(typeof(LineJoin)))
                {
                    ...
                    rc.DrawLine(new[] { p1, pMid, p2 }, PlotterColors.CornflowerBlue, STROKE_THICKNESS, EdgeRenderingMode.PreferGeometricAccuracy, lineJoin: lineJoin);
    ...
    public static PlotModel EllipseDrawing()
    {
        ...
        model.Annotations.Add(new DelegateAnnotation(rc =>
        {
            var rect = new PlotterRect(CENTER_X - RADIUS_X, CENTER_Y - RADIUS_Y, RADIUS_X * 2, RADIUS_Y * 2);
            ...
            rc.DrawPolygon(points, PlotterColors.Undefined, PlotterColors.Black, 4, EdgeRenderingMode.PreferGeometricAccuracy);
            rc.DrawEllipse(rect, PlotterColors.Undefined, PlotterColors.White, 2, EdgeRenderingMode.PreferGeometricAccuracy);
            rc.DrawText(new ScreenPoint(CENTER_X, CENTER_Y), "The white ellipse (drawn by Renderer) should match the black ellipse (drawn as Path).", PlotterColors.Black, fontSize: 12, horizontalAlignment: HorizontalAlignment.Center, verticalAlignment: VerticalAlignment.Middle);
        }));
        return model;
    }
    ...
    public class DelegateAnnotation : Annotation
    {
        ...
        /// <inheritdoc/>
        public override PlotterRect GetClippingRect()
        {
            return PlotterRect.Everything;
        }
    }
}
