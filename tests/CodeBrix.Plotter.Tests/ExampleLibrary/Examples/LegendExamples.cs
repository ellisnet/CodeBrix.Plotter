...
public static class LegendExamples
{
    ...
    public static PlotModel LegendRightTopInside()
    {
        ...
        var l = new Legend
        {
            ...
            LegendBackground = PlotterColor.FromAColor(200, PlotterColors.White),
    ...
    {
        var model = CreateModel();
        model.DefaultColors = new List<PlotterColor> { PlotterColors.Black, PlotterColors.Gray };
        var l = new Legend
        {
    ...
    public static PlotModel LegendFullWidth()
    {
        ...
        model.PlotMargins = new PlotterThickness(50);
