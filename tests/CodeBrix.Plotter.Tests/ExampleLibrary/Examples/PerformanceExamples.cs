...
public class PerformanceExamples
{
    ...
    public static PlotModel LineSeriesItemsSourceMapping()
    {
        ...
        var points = new List<DataPoint>();
        AddPoints(points, 100000);
        var rects = points.Select(pt => new PlotterRect(pt.X, pt.Y, 0, 0)).ToList();
        s1.ItemsSource = rects;
        s1.Mapping = r => new DataPoint(((PlotterRect)r).Left, ((PlotterRect)r).Top);
        model.Series.Add(s1);
    ...
    public static PlotModel ScatterSeriesSquaresOutline()
    {
        ...
        var s1 = new ScatterSeries { MarkerStroke = PlotterColors.Black };
        AddPoints(s1.Points, 2000);
        model.Series.Add(s1);
        return model;
    }
    ...
    public static PlotModel ScatterSeriesSquaresOutlineOnly()
    {
        ...
        var s1 = new ScatterSeries { MarkerFill = PlotterColors.Transparent, MarkerStroke = PlotterColors.Black };
        AddPoints(s1.Points, 2000);
        model.Series.Add(s1);
        return model;
    }
    ...
    public static PlotModel ScatterSeriesCirclesOutline()
    {
        ...
        var s1 = new ScatterSeries { MarkerType = MarkerType.Circle, MarkerStroke = PlotterColors.Black };
        AddPoints(s1.Points, 2000);
        model.Series.Add(s1);
        return model;
    }
    ...
    public static PlotModel ScatterSeriesCrosses()
    {
        ...
        var s1 = new ScatterSeries
        {
            ...
            MarkerFill = PlotterColors.Undefined,
