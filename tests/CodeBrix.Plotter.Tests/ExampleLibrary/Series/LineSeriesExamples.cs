...
public class LineSeriesExamples
{
    ...
    public static PlotModel CustomStyle()
    {
        ...
        lineSeries1.Color = PlotterColors.SkyBlue;
        ...
        lineSeries1.MarkerStroke = PlotterColors.White;
        lineSeries1.MarkerFill = PlotterColors.SkyBlue;
    ...
    public static PlotModel MarkerTypes()
    {
        ...
        var l = new Legend
        {
            LegendBackground = PlotterColor.FromAColor(220, PlotterColors.White),
        ...
        {
            ls.Color = PlotterColors.Red;
            ls.MarkerStroke = PlotterColors.Black;
            ls.MarkerFill = PlotterColors.Green;
    ...
    public static PlotModel LineStyles()
    {
        ...
        {
            lineSeries.Color = PlotterColors.Red;
    ...
    public static PlotModel BrokenLine()
    {
        ...
        s1.BrokenLineColor = PlotterColors.Gray;
        ...
        s2.BrokenLineColor = PlotterColors.Automatic;
    ...
    public static PlotModel MarkerColorOptions()
    {
        ...
        s2.Color = PlotterColors.LightBlue;
        model.Series.Add(s2);
        ...
        s3.MarkerFill = PlotterColors.Black;
        model.Series.Add(s3);
        ...
        s4.MarkerFill = PlotterColors.OrangeRed;
        s4.Color = PlotterColors.Orange;
        model.Series.Add(s4);
    ...
    private static CodeBrix.Plotter.Series.Series CreateRandomLineSeries(int n, string title, MarkerType markerType)
    {
        var s1 = new LineSeries { Title = title, MarkerType = markerType, MarkerStroke = PlotterColors.Black, MarkerStrokeThickness = 1.0 };
        double x = 0;
        double y = 0;
        for (int i = 0; i < n; i++)
        {
