...
public class ErrorBarSeriesExamples
{
    ...
    public static PlotModel GetErrorBarSeries()
    {
        ...
        var s1 = new ErrorBarSeries { Title = "Series 1", IsStacked = false, StrokeColor = PlotterColors.Black, StrokeThickness = 1 };
        ...
        var s2 = new ErrorBarSeries { Title = "Series 2", IsStacked = false, StrokeColor = PlotterColors.Black, StrokeThickness = 1 };
