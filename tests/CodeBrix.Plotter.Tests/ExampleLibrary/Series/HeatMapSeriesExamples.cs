...
public class HeatMapSeriesExamples
{
    ...
    public static PlotModel CreatePeaks(PlotterPalette palette = null, bool includeContours = true, int n = 100)
    {
        double x0 = -3.1;
        double x1 = 3.1;
        double y0 = -3;
        ...
        var colorAxis = new LinearColorAxis { Position = AxisPosition.Right, HighColor = PlotterColors.Gray, LowColor = PlotterColors.Black };
        ...
        if (includeContours)
        {
            var cs = new ContourSeries
            {
                ...
                FontSize = 0,
                ContourLevelStep = 1,
                LabelBackground = PlotterColors.Undefined,
    ...
    public static PlotModel NotInterpolatedWithNanValue()
    {
        ...
        ca.InvalidNumberColor = PlotterColors.Transparent;
        var hms = (HeatMapSeries)model.Series[0];
        hms.Data[0, 1] = double.NaN;
        hms.Data[1, 0] = double.NaN;
        return model;
    ...
    public static PlotModel ConfusionMatrix()
    {
        ...
        var palette = PlotterPalette.Interpolate(50, PlotterColors.White, PlotterColors.Black);

        var lca = new LinearColorAxis { Position = AxisPosition.Right, Palette = palette, HighColor = PlotterColors.White, LowColor = PlotterColors.White };
        model.Axes.Add(lca);
    ...
    public static PlotModel LogXInterpolated()
    {
        ...
        model.Axes.Add(new LinearColorAxis { Position = AxisPosition.Right, Palette = PlotterPalettes.Gray(500), HighColor = PlotterColors.White, LowColor = PlotterColors.Black });
    ...
    private static PlotModel Create6X4(string title)
    {
        ...
        model.Axes.Add(new LinearColorAxis { Position = AxisPosition.Right, Palette = PlotterPalettes.Jet(500), HighColor = PlotterColors.White, LowColor = PlotterColors.Black });
