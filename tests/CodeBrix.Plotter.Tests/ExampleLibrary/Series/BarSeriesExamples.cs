...
public class BarSeriesExamples
{
    ...
    public static PlotModel BindingItemsSource()
    {
        ...
        {
            FillColor = PlotterColor.FromArgb(255, 78, 154, 6),
            ValueField = "Value1",
            Title = "2009",
            ItemsSource = items
        };
        ...
        {
            FillColor = PlotterColor.FromArgb(255, 200, 141, 0),
            ValueField = "Value2",
            Title = "2010",
            ItemsSource = items
        };
        ...
        {
            FillColor = PlotterColor.FromArgb(255, 204, 0, 0),
            ValueField = "Value3",
            Title = "2011",
            ItemsSource = items
        };
    ...
    public static PlotModel EmptyCategoryAxis()
    {
        ...
        var valueAxis = new LinearAxis
        {
            ...
            ExtraGridlineColor = PlotterColors.Black,
    ...
    public static PlotModel LogAxisBaseValue()
    {
        ...
        model.Legends.Add(l);
        var s1 = new BarSeries { Title = "Series 1", BaseValue = 0.1, StrokeColor = PlotterColors.Black, StrokeThickness = 1 };
        s1.Items.Add(new BarItem { Value = 25 });
    ...
    public static PlotModel LogAxisBaseLine()
    {
        ...
        model.Legends.Add(l);
        var s1 = new BarSeries { Title = "Series 1", BaseLine = 0.1, StrokeColor = PlotterColors.Black, StrokeThickness = 1 };
        s1.Items.Add(new BarItem { Value = 25 });
        s1.Items.Add(new BarItem { Value = 37 });
        s1.Items.Add(new BarItem { Value = 18 });
        s1.Items.Add(new BarItem { Value = 40 });
    ...
    private static PlotModel CreateSimpleModel(bool stacked, string title)
    {
        ...
        var s1 = new BarSeries { Title = "Series 1", IsStacked = stacked, StrokeColor = PlotterColors.Black, StrokeThickness = 1 };
        s1.Items.Add(new BarItem { Value = 25 });
        s1.Items.Add(new BarItem { Value = 137 });
        s1.Items.Add(new BarItem { Value = 18 });
        s1.Items.Add(new BarItem { Value = 40 });

        var s2 = new BarSeries { Title = "Series 2", IsStacked = stacked, StrokeColor = PlotterColors.Black, StrokeThickness = 1 };
        s2.Items.Add(new BarItem { Value = 12 });
        s2.Items.Add(new BarItem { Value = 14 });
        s2.Items.Add(new BarItem { Value = 120 });
        s2.Items.Add(new BarItem { Value = 26 });
    ...
    private static PlotModel CreateModelWithNegativeValues(bool stacked, string title)
    {
        ...
        var s3 = new BarSeries { Title = "Series 3", IsStacked = stacked, StrokeColor = PlotterColors.Black, StrokeThickness = 1 };
        ...
        var s4 = new BarSeries { Title = "Series 4", IsStacked = stacked, StrokeColor = PlotterColors.Black, StrokeThickness = 1 };
    ...
    public static PlotModel DifferentColors()
    {
        ...
        series.Items.Add(new BarItem { Value = 1, Color = PlotterColors.Red });
        series.Items.Add(new BarItem { Value = 2, Color = PlotterColors.Green });
        series.Items.Add(new BarItem { Value = 1, Color = PlotterColors.Blue });
    ...
    public static PlotModel AllInOne()
    {
        ...
        s1.Items.Add(new BarItem { Value = 18 });
        s1.Items.Add(new BarItem { Value = 40 });
        var s2 = new BarSeries { Title = "Series 2", IsStacked = true, StrokeColor = PlotterColors.Black, StrokeThickness = 1, StackGroup = "3" };
        s2.Items.Add(new BarItem { Value = -12 });
        s2.Items.Add(new BarItem { Value = -14 });
        s2.Items.Add(new BarItem { Value = -120 });
        s2.Items.Add(new BarItem { Value = -26 });

        var s3 = new BarSeries { Title = "Series 3", IsStacked = true, StrokeColor = PlotterColors.Black, StrokeThickness = 1, StackGroup = "5", IsVisible = false };
        s3.Items.Add(new BarItem { Value = 21 });
        s3.Items.Add(new BarItem { Value = 8 });
        s3.Items.Add(new BarItem { Value = 48 });
        s3.Items.Add(new BarItem { Value = 3 });
        var s4 = new BarSeries { Title = "Series 4", IsStacked = true, StrokeColor = PlotterColors.Black, StrokeThickness = 1, StackGroup = "5", LabelFormatString = "{0:0}", LabelPlacement = LabelPlacement.Middle };
        ...
        var s5 = new BarSeries { Title = "Series 5", IsStacked = false, StrokeColor = PlotterColors.Black, StrokeThickness = 1 };
        ...
        var s6 = new BarSeries { Title = "Series 6", IsStacked = false, StrokeColor = PlotterColors.Black, StrokeThickness = 1, LabelFormatString = "{0:0}", LabelPlacement = LabelPlacement.Base };
        ...
        var s7 = new BarSeries { Title = "Series 7", IsStacked = true, OverlapsStack = true, StrokeColor = PlotterColors.Black, StrokeThickness = 1, LabelFormatString = "{0:0}", LabelPlacement = LabelPlacement.Base, StackGroup = "3", BarWidth = 0.5 };
