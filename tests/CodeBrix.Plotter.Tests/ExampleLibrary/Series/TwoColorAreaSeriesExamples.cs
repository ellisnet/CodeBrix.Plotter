...
public class TwoColorAreaSeriesExamples
{
    ...
    public static PlotModel TwoColorAreaSeries()
    {
        ...
        var s1 = new TwoColorAreaSeries
        {
            ...
            Color2 = PlotterColors.LightBlue,
            MarkerFill = PlotterColors.Tomato,
            MarkerFill2 = PlotterColors.LightBlue,
            StrokeThickness = 2,
            Limit = -1,
    ...
    public static PlotModel TwoColorAreaSeries2()
    {
        ...
        var s1 = new TwoColorAreaSeries
        {
            ...
            Color2 = PlotterColors.Brown,
            MarkerFill = PlotterColors.Red,
            Fill = PlotterColors.Tomato,
            Fill2 = PlotterColors.LightBlue,
            MarkerFill2 = PlotterColors.Blue,
            MarkerStroke = PlotterColors.Brown,
            MarkerStroke2 = PlotterColors.Black,
            StrokeThickness = 2,
            Limit = 0,
            MarkerType = MarkerType.Circle,
            MarkerSize = 3,
