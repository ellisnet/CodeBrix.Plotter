...
public class Issues
{
    ...
    public static PlotModel IssueHalfPolarReversedAxesPart1()
    {
        ...
        plotModel.PlotType = CodeBrix.Plotter.PlotType.Polar;
        plotModel.Axes.Add(
            new AngleAxis()
            {
    ...
    public static PlotModel InfinitySizePolyline()
    {
        ...
        var series = new CodeBrix.Plotter.Series.LineSeries();
    ...
    public static PlotModel RectangleAnnotationAxisClipping()
    {
        var model = new PlotModel
        {
            ...
            PlotAreaBorderThickness = new PlotterThickness(0),
            Axes =
            {
                new LinearAxis
                {
            ...
            Annotations =
            {
                ...
                {
                    Fill = PlotterColor.FromArgb(100, 255, 0, 0),
                ...
                new RectangleAnnotation
                {
                    Fill = PlotterColor.FromArgb(100, 0, 0, 255),
                    Stroke = PlotterColors.Black,
                    StrokeThickness = 1,
                    MinimumX = 70,
                    MaximumX = 90,
                ...
                new RectangleAnnotation
                {
                    Fill = PlotterColor.FromArgb(100, 0, 255, 0),
                    Stroke = PlotterColors.Black,
                    StrokeThickness = 1,
                    MinimumY = 80,
                    MaximumY = 85,
                ...
                new RectangleAnnotation
                {
                    Fill = PlotterColor.FromArgb(50, 100, 100, 100),
                    Stroke = PlotterColors.Black,
                    StrokeThickness = 1,
    ...
    public static PlotModel ColorCodingOnScatterPlots()
    {
        ...
        var colorAxis = new LinearColorAxis { Position = AxisPosition.Right, Palette = PlotterPalettes.Jet(500), Minimum = 0, Maximum = 5, HighColor = PlotterColors.Gray, LowColor = PlotterColors.Black };
    ...
    public static PlotModel GridLinesBothDifferentColors()
    {
        ...
        {
            MajorGridlineStyle = LineStyle.Solid,
            MajorGridlineColor = PlotterColors.Black,
            MajorGridlineThickness = 4,
            MinorGridlineStyle = LineStyle.Solid,
            MinorGridlineColor = PlotterColors.LightBlue,
    ...
    public static PlotModel MouseDownEvent()
    {
        ...
        var s1 = new LineSeries
        {
            ...
            MarkerFill = PlotterColors.SkyBlue,
    ...
    public static PlotModel ValueTime()
    {
        var plotModel1 = new PlotModel
        {
            PlotAreaBackground = PlotterColors.Gray,
            PlotAreaBorderColor = PlotterColors.Gainsboro,
            PlotAreaBorderThickness = new PlotterThickness(2),
            Title = "Value / Time"
        };

        var l = new Legend
        {
            LegendBackground = PlotterColor.FromArgb(200, 255, 255, 255),
            LegendBorder = PlotterColors.Black,
        ...
        var lineSeries1 = new LineSeries
        {
            ...
            LineStyle = LineStyle.Solid,
            MarkerFill = PlotterColors.Black,
            MarkerSize = 2,
    ...
    [Example("Argument out of range in CodeBrix.Plotter mouse over (Closed)")]
    public static PlotModel ArgumentOutOfRangeInMouseOver()
    {
        var model = new PlotModel { Title = "Argument out of range in CodeBrix.Plotter mouse over" };
    ...
    public static PlotModel DefaultAnnotationLayer()
    {
        ...
        areaSeries1.Color = PlotterColors.Red;
        areaSeries1.Color2 = PlotterColors.Blue;
        areaSeries1.Fill = PlotterColors.Yellow;
    ...
    public static PlotModel ScatterSeries()
    {
        var plotModel1 = new PlotModel
        {
            ...
            PlotMargins = new PlotterThickness(50, 5, 5, 50),
            Padding = new PlotterThickness(0),
            PlotAreaBorderThickness = new PlotterThickness(1, 1, 1, 1),
            PlotAreaBorderColor = PlotterColors.Black,
            TextColor = PlotterColors.Black
        };
        ...
        plotModel1.Axes.Add(new LinearAxis
        {
            ...
            TicklineColor = PlotterColors.Black,
            Minimum = 0,
            MaximumPadding = 0.05
        });
        ...
        var referenceCurve = new LineSeries
        {
            Title = "Reference",
            InterpolationAlgorithm = InterpolationAlgorithms.CanonicalSpline,
            Color = PlotterColor.FromArgb(255, 89, 128, 168)
        };
        var upperBoundary = new LineSeries
        {
            LineStyle = LineStyle.Dot,
            Color = PlotterColors.LightGray,
            InterpolationAlgorithm = InterpolationAlgorithms.CanonicalSpline,
            Title = string.Empty
        };
    ...
    public static PlotModel PositionAtZeroCrossingNoPlotBorder()
    {
        ...
        pm.PlotAreaBorderThickness = new PlotterThickness(0);
    ...
    public static PlotModel ImageAnnotationWithWidthHeightCrashes()
    {
        ...
        var palette = new PlotterColor[256];
        for (int i = 0; i < palette.Length; i++)
        {
            palette[i] = PlotterColor.FromArgb(128, (byte)i, 0, 0);
        }

        var image = PlotterImage.Create(buf, palette, ImageFormat.Bmp);
    ...
    public static PlotModel TransposedHeatMap()
    {
        ...
        model.Axes.Add(new LinearColorAxis { Position = AxisPosition.Right, Palette = PlotterPalettes.Jet(500), HighColor = PlotterColors.Gray, LowColor = PlotterColors.Black });
...
new LinearAxis() { Key = "x_axis", AbsoluteMinimum = x0, AbsoluteMaximum = x1, Position = AxisPosition.Top });
    ...
    public static PlotModel ColorAxisTitle()
    {
        ...
        model.Axes.Add(new LinearColorAxis { Title = "wrong Placement", Position = AxisPosition.Right, Palette = PlotterPalettes.Jet(500), HighColor = PlotterColors.Gray, LowColor = PlotterColors.Black });
    ...
    public static PlotModel IndexOutOfRangeContour()
    {
        ...
        model.Axes.Add(new LinearColorAxis { Position = AxisPosition.Right, Palette = PlotterPalettes.Jet(5) });
    ...
    public static PlotModel PlotHeatMap()
    {
        ...
        model.Axes.Add(new LinearColorAxis
        {
            ...
            Palette = PlotterPalettes.Jet(500),
    ...
    {
        return new PlotModel { Title = "Too much padding", Padding = new PlotterThickness(0, 0, 0, 10000) };
    }
    ...
    public static PlotModel TooMuchPaddingWithLegend()
    {
        var model = new PlotModel
        {
            ...
            Padding = new PlotterThickness(500)
        };
    ...
    public static PlotModel ExportTransparentTextAnnotationToSvg()
    {
        ...
        plot.Background = PlotterColors.Black;
        plot.Annotations.Add(new TextAnnotation
        {
            TextPosition = new DataPoint(25, 0),
            Text = "Opaque",
            TextColor = PlotterColor.FromRgb(255, 0, 0),
            FontSize = 10,
        });
        plot.Annotations.Add(new TextAnnotation
        {
            ...
            TextColor = PlotterColor.FromArgb(125, 255, 0, 0),
            FontSize = 10,
        });
        plot.Annotations.Add(new TextAnnotation
        {
            ...
            Text = "Transparent1",
            TextColor = PlotterColor.FromArgb(0, 255, 0, 0),
            FontSize = 10,
        });
        plot.Annotations.Add(new TextAnnotation
        {
            ...
            Text = "Transparent2",
            TextColor = PlotterColors.Transparent,
            FontSize = 10,
        });
    ...
    public static PlotModel ZeroCrossingQuadrantAxes()
    {
        ...
        var xaxis = new LinearAxis
        {
            ...
            AxislineStyle = LineStyle.Solid,
            Minimum = 0,
            AxislineColor = PlotterColors.Red,
            StartPosition = 0.5,
            EndPosition = 1,
            PositionAtZeroCrossing = true,
            AbsoluteMinimum = 0,
        ...
        var xaxis2 = new LinearAxis
        {
            ...
            AxislineStyle = LineStyle.Solid,
            Minimum = 0,
            AxislineColor = PlotterColors.Gold,
            StartPosition = 0.5,
            EndPosition = 0,
            PositionAtZeroCrossing = true,
            IsAxisVisible = true,
        ...
        var yaxis = new LinearAxis
        {
            ...
            AxislineStyle = LineStyle.Solid,
            Minimum = 0,
            AxislineColor = PlotterColors.Green,
            PositionTier = 0,
            StartPosition = 0.5,
            EndPosition = 1,
            PositionAtZeroCrossing = true,
        ...
        var yaxis2 = new LinearAxis
        {
            ...
            AxislineStyle = LineStyle.Solid,
            Minimum = 0,
            AxislineColor = PlotterColors.Violet,
            PositionTier = 0,
            StartPosition = 0.5,
            EndPosition = 0,
            PositionAtZeroCrossing = true,
        ...
        plot.PlotAreaBorderThickness = new PlotterThickness(1, 1, 1, 1);
    ...
    public static PlotModel HitTrackerIndexOutOfRangeExceptionWithHeatMapSeries()
    {
        ...
        List<PlotterColor> jetTransparent = new List<PlotterColor>();
        foreach (var item in PlotterPalettes.Jet(1000).Colors)
        {
            jetTransparent.Add(PlotterColor.FromAColor(220, item));
        }
        PlotterPalette myPalette = new PlotterPalette(jetTransparent);

        plot.PlotAreaBackground = PlotterColors.White;
        plot.DefaultFontSize = 14;
        //plotModel.DefaultColors = SeriesColors;
        plot.Padding = new PlotterThickness(0);
        plot.TitlePadding = 0;
    ...
    public static PlotModel ZeroCrossingWithInsertHorizontalAxisAndTransparentBorder()
    {
        var plotModel1 = new PlotModel
        {
            ...
            PlotAreaBorderThickness = new PlotterThickness(5),
            PlotAreaBorderColor = PlotterColor.FromArgb(127, 127, 127, 127),
            PlotMargins = new PlotterThickness(10, 10, 10, 10)
        };
        plotModel1.Axes.Add(new LinearAxis
        {
            Minimum = -100,
    ...
    public static PlotModel ContourSeriesProduceFakeConnections()
    {
        ...
        using (var stream = typeof(Issues).GetTypeInfo().Assembly.GetManifestResourceStream("CodeBrix.Plotter.Tests.ExampleLibrary.Resources.DodgyContourData.tsv"))
        {
        ...
        using (var stream = typeof(Issues).GetTypeInfo().Assembly.GetManifestResourceStream("CodeBrix.Plotter.Tests.ExampleLibrary.Resources.X.txt"))
        {
            using (var reader = new System.IO.StreamReader(stream))
            {
        ...
        using (var stream = typeof(Issues).GetTypeInfo().Assembly.GetManifestResourceStream("CodeBrix.Plotter.Tests.ExampleLibrary.Resources.Y.txt"))
        {
            using (var reader = new System.IO.StreamReader(stream))
            {
        ...
        var caxis = new LinearColorAxis() { Position = AxisPosition.Right, Palette = PlotterPalettes.Gray(100) };
        ...
        {
            TextColor = PlotterColors.Transparent,
            LabelBackground = PlotterColors.Transparent,
            ContourLevels = tmp,
            Data = data,
    ...
    public static PlotModel BarSeriesHitTestBug2038()
    {
        ...
        var s1 = new BarSeries { Title = "Series 1", IsStacked = true, StrokeColor = PlotterColors.Black, StrokeThickness = 1, StackGroup = "3" };
        int i = 0;
