...
public class DiscussionExamples
{
    ...
    public static PlotModel HeatMapSeriesInterpolationColor()
    {
        ...
        model.Axes.Add(new LinearColorAxis { Position = AxisPosition.Right, Palette = new PlotterPalette(PlotterColors.Red, PlotterColors.Green, PlotterColors.Blue) });
    ...
    public static PlotModel MediumIntensityColors()
    {
        ...
        {
            PlotterColor.FromRgb(114, 114, 114),
            PlotterColor.FromRgb(241, 89, 95),
            PlotterColor.FromRgb(121, 195, 106),
            PlotterColor.FromRgb(89, 154, 211),
            PlotterColor.FromRgb(249, 166, 90),
            PlotterColor.FromRgb(158, 102, 171),
            PlotterColor.FromRgb(205, 112, 88),
            PlotterColor.FromRgb(215, 127, 179)
        };
    ...
    public static PlotModel BrewerColors4()
    {
        ...
        model.DefaultColors = new[]
        {
            PlotterColor.FromRgb(127, 201, 127),
            PlotterColor.FromRgb(190, 174, 212),
            PlotterColor.FromRgb(253, 192, 134),
            PlotterColor.FromRgb(255, 255, 153)
        };
    ...
    public static PlotModel BrewerColors6()
    {
        ...
        model.DefaultColors = new[]
        {
            PlotterColor.FromRgb(166, 206, 227),
            PlotterColor.FromRgb(31, 120, 180),
            PlotterColor.FromRgb(178, 223, 138),
            PlotterColor.FromRgb(51, 160, 44),
            PlotterColor.FromRgb(251, 154, 153),
            PlotterColor.FromRgb(227, 26, 28)
        };
    ...
    public static PlotModel SameColorOfLineSeriesAndAxisTitleAndLabels()
    {
        ...
        var color = PlotterColors.IndianRed;
    ...
    {
        var model = new PlotModel { Title = "Custom arrow series", PlotType = PlotType.Polar, PlotAreaBorderColor = PlotterColors.Undefined };
    ...
    {
        var plotModel = new PlotModel { PlotType = PlotType.Cartesian, PlotAreaBorderThickness = new PlotterThickness(0) };
        ...
        var xaxis = new DateTimeAxis
                        {
                            ...
                            AxislineColor = PlotterColor.FromRgb(153, 153, 153),
        ...
        var series1 = new LineSeries
                          {
                              Color = PlotterColor.FromRgb(44, 169, 173),
                              StrokeThickness = 1,
                              MarkerType = MarkerType.Circle,
                              MarkerStroke = PlotterColors.Blue,
