...
public class AxisTests
{
    ...
    public void A00_NoAxesDefined()
    {
        ...
        PlotterAssert.AreEqual(plot, "A00");
    }
    ...
    public void A01_SimpleAxes()
    {
        ...
        PlotterAssert.AreEqual(plot, "A01");
    }
    ...
    public void A02_ReversedAxes()
    {
        ...
        PlotterAssert.AreEqual(plot, "A02");
    }

    [Fact]
    public void A11_SmallRangeAxis()
    {
        var plot = new PlotModel { Title = "Small range axis", PlotMargins = new PlotterThickness(80, 60, 50, 50) };
        plot.Axes.Add(new LinearAxis { Position = AxisPosition.Bottom, Title = "X-axis" });
        plot.Axes.Add(new LinearAxis { Position = AxisPosition.Left, Title = "Y-axis" });
        ...
        PlotterAssert.AreEqual(plot, "A11");
    }

    [Fact]
    public void A12_LargeRangeAxis()
    {
        var plot = new PlotModel { Title = "Large range axis", PlotMargins = new PlotterThickness(80, 60, 50, 50) };
        plot.Axes.Add(new LinearAxis { Position = AxisPosition.Bottom, Title = "X-axis" });
        plot.Axes.Add(new LinearAxis { Position = AxisPosition.Left, Title = "Y-axis" });
        ...
        PlotterAssert.AreEqual(plot, "A12");
    }

    [Fact]
    public void A13_BadConditionedAxis()
    {
        var plot = new PlotModel { Title = "Bad conditioned axis", PlotMargins = new PlotterThickness(80, 60, 50, 50) };
        plot.Axes.Add(new LinearAxis { Position = AxisPosition.Bottom, Title = "X-axis" });
        plot.Axes.Add(new LinearAxis { Position = AxisPosition.Left, Title = "Y-axis" });
        ...
        PlotterAssert.AreEqual(plot, "A13");
    }
    ...
    public void A13B_BadConditionedAxis_SettingMinimumRange()
    {
        var plot = new PlotModel
        {
            ...
            PlotMargins = new PlotterThickness(80, 60, 50, 50)
        };
        ...
        PlotterAssert.AreEqual(plot, "A13B");
    }
    ...
    public void A14_ConstantValue()
    {
        ...
        PlotterAssert.AreEqual(plot, "A14");
    }
    ...
    public void A15_SinglePoint()
    {
        ...
        PlotterAssert.AreEqual(plot, "A15");
    }
    ...
    public void A16_TwoClosePoints()
    {
        ...
        PlotterAssert.AreEqual(plot, "A16");
    }
    ...
    public void B01_LogarithmicAxis()
    {
        ...
        PlotterAssert.AreEqual(plot, "B01");
    }
    ...
    public void B02_LogarithmicAxis()
    {
        ...
        PlotterAssert.AreEqual(plot, "B02");
    }
    ...
    public void B03_LogarithmicAxis()
    {
        ...
        PlotterAssert.AreEqual(plot, "B03");
    }
    ...
    public void B04_LogarithmicAxis_Padding()
    {
        ...
        PlotterAssert.AreEqual(plot, "B04");
    }
    ...
    public void B05_LogarithmicAxis_SuperExponentialFormat()
    {
        ...
        PlotterAssert.AreEqual(plot, "B05");
    }

    [Fact]
    public void C01_DateTimeAxis()
    {
        var plot = new PlotModel { Title = "DateTime axis", PlotMargins = new PlotterThickness(100, 40, 20, 100) };
        ...
        PlotterAssert.AreEqual(plot, "C01");
    }
    ...
    public void C02_DateTimeAxis_WithSomeUndefinedPoints()
    {
        ...
        PlotterAssert.AreEqual(plot, "C02");
    }
    ...
    public void C03_DateTimeAxis_WithAllUndefinedPoints()
    {
        ...
        PlotterAssert.AreEqual(plot, "C03");
    }
    ...
    public void D01_InvalidAbsoluteMaxMin()
    {
        ...
        (plot.GetLastPlotException() as InvalidOperationException).Should().NotBeNull();
    }
    ...
    public void D02_InvalidMaxMin()
    {
        ...
        ((IPlotModel)plot).Update(true);
        plot.Axes[0].ActualMaximum.Should().Be(100);
        plot.Axes[0].ActualMinimum.Should().Be(0);
    }
    ...
    public void D03_InvalidMaxMin()
    {
        ...
        ((IPlotModel)plot).Update(true);
        plot.Axes[0].ActualMaximum.Should().Be(100);
        plot.Axes[0].ActualMinimum.Should().Be(1);
    }
    ...
    public void Axis_DesiredMargin()
    {
        ...
        yaxis.DesiredMargin.Left.Should().BeApproximately(35.0, 0.5);
        yaxis.DesiredMargin.Top.Should().BeApproximately(5, 0.5);
        yaxis.DesiredMargin.Right.Should().BeApproximately(0.0, 1e-6);
        yaxis.DesiredMargin.Bottom.Should().BeApproximately(5, 0.5);

        xaxis.DesiredMargin.Left.Should().BeApproximately(5, 0.5);
        xaxis.DesiredMargin.Top.Should().BeApproximately(0.0, 1e-6);
        xaxis.DesiredMargin.Right.Should().BeApproximately(5, 0.5);
        xaxis.DesiredMargin.Bottom.Should().BeApproximately(35.0, 0.5);
        ...
        yaxis.DesiredMargin.Left.Should().BeApproximately(50.0, 0.5);
        yaxis.DesiredMargin.Top.Should().BeApproximately(5, 0.5);
        yaxis.DesiredMargin.Right.Should().BeApproximately(0.0, 1e-6);
        yaxis.DesiredMargin.Bottom.Should().BeApproximately(5, 0.5);

        xaxis.DesiredMargin.Left.Should().BeApproximately(12.5, 0.5);
        xaxis.DesiredMargin.Top.Should().BeApproximately(0.0, 1e-6);
        xaxis.DesiredMargin.Right.Should().BeApproximately(12.5, 0.5);
        xaxis.DesiredMargin.Bottom.Should().BeApproximately(35.0, 0.5);
    }
    ...
    public void Axis_DesiredMargin_WithPosition()
    {
        ...
        axis2.Zoom(0, 80);
        plot.UpdateAndRenderToNull(800, 600);
        axis1.DesiredMargin.Left.Should().BeApproximately(5, 0.5);
        axis1.DesiredMargin.Top.Should().BeApproximately(0, 1e-6);
        axis1.DesiredMargin.Right.Should().BeApproximately(0, 1e-6);
        axis1.DesiredMargin.Bottom.Should().BeApproximately(35, 0.5);

        axis2.DesiredMargin.Left.Should().BeApproximately(0d, 1e-6);
        axis2.DesiredMargin.Top.Should().BeApproximately(0d, 1e-6);
        axis2.DesiredMargin.Right.Should().BeApproximately(5, 0.5);
        axis2.DesiredMargin.Bottom.Should().BeApproximately(35, 0.5);

        // larger numbers on axis -> larger desired size
        axis1.Zoom(10000, 11000);
        axis2.Zoom(10000, 11000);
        plot.UpdateAndRenderToNull(800, 600);
        axis1.DesiredMargin.Left.Should().BeApproximately(12.5, 0.5);
        axis1.DesiredMargin.Top.Should().BeApproximately(0, 1e-6);
        axis1.DesiredMargin.Right.Should().BeApproximately(0, 1e-6);
        axis1.DesiredMargin.Bottom.Should().BeApproximately(35, 0.5);
        ...
        axis2.DesiredMargin.Left.Should().BeApproximately(0d, 1e-6);
        axis2.DesiredMargin.Top.Should().BeApproximately(0d, 1e-6);
        axis2.DesiredMargin.Right.Should().BeApproximately(12.5, 0.5);
        axis2.DesiredMargin.Bottom.Should().BeApproximately(35, 0.5);
    }
    ...
    public void Axis_MinimumRange_AbsoluteRange_DataOutOfRange()
    {
        ...
        plot.Axes[0].ActualMinimum.Should().BeApproximately(-100, 1e-5);
        plot.Axes[0].ActualMaximum.Should().BeApproximately(0.0, 1e-5);
    }
    ...
    public void Axis_VerticalAlignment_MinimumRange()
    {
        ...
        ((plot.Axes[0].ActualMaximum + plot.Axes[0].ActualMinimum) / 2).Should().BeApproximately(dataCenter, 1e-5);
        plot.Axes[0].ActualMinimum.Should().BeApproximately(dataCenter - 0.5, 1e-5);
        plot.Axes[0].ActualMaximum.Should().BeApproximately(dataCenter + 0.5, 1e-5);
    }
    ...
    public void Axis_VerticalAlignment_MinimumRange_AbsoluteMaximum()
    {
        ...
        plot.Axes[0].ActualMaximum.Should().BeApproximately(yaxis.AbsoluteMaximum, 0);
        ((plot.Axes[0].ActualMaximum + plot.Axes[0].ActualMinimum) / 2).Should().BeApproximately(yaxis.AbsoluteMaximum - (yaxis.MinimumRange / 2), 1e-5);
        plot.Axes[0].ActualMinimum.Should().BeApproximately(yaxis.AbsoluteMaximum - yaxis.MinimumRange, 1e-5);
    }
    ...
    public void Axis_VerticalAlignment_MinimumRange_AbsoluteMinimum()
    {
        ...
        plot.Axes[0].ActualMinimum.Should().BeApproximately(yaxis.AbsoluteMinimum, 0);
        ((plot.Axes[0].ActualMaximum + plot.Axes[0].ActualMinimum) / 2).Should().BeApproximately(yaxis.AbsoluteMinimum + (yaxis.MinimumRange / 2), 1e-5);
        plot.Axes[0].ActualMaximum.Should().BeApproximately(yaxis.AbsoluteMinimum + yaxis.MinimumRange, 1e-5);
    }
    ...
    public void Axis_VerticalAlignment_MaximumRange()
    {
        ...
        // Center should be the between data min and max
        ((plot.Axes[0].ActualMaximum + plot.Axes[0].ActualMinimum) / 2).Should().BeApproximately(dataCenter, 1e-5);
        plot.Axes[0].ActualMinimum.Should().BeApproximately(dataCenter - 0.05, 1e-5);
        plot.Axes[0].ActualMaximum.Should().BeApproximately(dataCenter + 0.05, 1e-5);
    }
    ...
    public void Axis_VerticalAlignment_MaximumRange_AbsoluteMaximum()
    {
        ...
        plot.Axes[0].ActualMaximum.Should().BeApproximately(yaxis.AbsoluteMaximum, 0);
        ((plot.Axes[0].ActualMaximum + plot.Axes[0].ActualMinimum) / 2).Should().BeApproximately(yaxis.AbsoluteMaximum - (yaxis.MaximumRange / 2), 1e-6);
        plot.Axes[0].ActualMinimum.Should().BeApproximately(yaxis.AbsoluteMaximum - yaxis.MaximumRange, 1e-6);
    }
    ...
    public void Axis_VerticalAlignment_MaximumRange_AbsoluteMinimum()
    {
        ...
        plot.Axes[0].ActualMinimum.Should().BeApproximately(yaxis.AbsoluteMinimum, 0);
        ((plot.Axes[0].ActualMaximum + plot.Axes[0].ActualMinimum) / 2).Should().BeApproximately(yaxis.AbsoluteMinimum + (yaxis.MaximumRange / 2), 1e-6);
        plot.Axes[0].ActualMaximum.Should().BeApproximately(yaxis.AbsoluteMinimum + yaxis.MaximumRange, 1e-6);
    }
    ...
    public void Axis_Toggle_Between_Linear_And_Log_Axis()
    {
        ...
        plot.Axes[0].DataMinimum.Should().Be(0.004);
    }
    ...
    public void Axis_Padding()
    {
        ...
        yaxis.ActualMinimum.Should().BeApproximately(4 - 6 * 0.2, 0);
        yaxis.ActualMaximum.Should().BeApproximately(10 + 6 * 0.1, 1e-6);
    }
    ...
    public void Axis_ZeroMargin()
    {
        ...
        yaxis.ClipMinimum.Should().BeApproximately(yaxis.ActualMinimum, 0);
        yaxis.ClipMaximum.Should().BeApproximately(yaxis.ActualMaximum, 0);

        yaxis.Transform(yaxis.ClipMinimum).Should().BeApproximately(plot.PlotArea.Bottom, 1e-6);
        yaxis.Transform(yaxis.ClipMaximum).Should().BeApproximately(plot.PlotArea.Top, 1e-6);
    }
    ...
    public void Axis_ZeroDataMargin()
    {
        ...
        yaxis.ActualMinimum.Should().BeApproximately(0, 0);
        yaxis.ActualMaximum.Should().BeApproximately(10, 0);
    }
    ...
    public void Axis_NonZeroMargin()
    {
        ...
        yaxis.Transform(yaxis.ClipMinimum).Should().BeApproximately(plot.PlotArea.Bottom - 20, 1e-6);
        yaxis.Transform(yaxis.ClipMaximum).Should().BeApproximately(plot.PlotArea.Top + 30, 1e-6);
    }
    ...
    public void Axis_NonZeroDataMargin()
    {
        ...
        yaxis.Transform(yaxis.ActualMinimum).Should().BeApproximately(yaxis.Transform(yaxis.ClipMinimum) - 15, 1e-6);
        yaxis.Transform(yaxis.ActualMaximum).Should().BeApproximately(yaxis.Transform(yaxis.ClipMaximum) + 10, 1e-6);
    }
    ...
    public void Axis_MarginsAndDataMargins()
    {
        ...
        yaxis.ClipMinimum.Should().NotBe(0);
        yaxis.ClipMaximum.Should().NotBe(10);
        yaxis.ActualMinimum.Should().BeApproximately(0, 0);
        yaxis.ActualMaximum.Should().BeApproximately(10, 0);

        yaxis.Transform(yaxis.ClipMinimum).Should().BeApproximately(plot.PlotArea.Bottom - 5, 1e-6);
        yaxis.Transform(yaxis.ClipMaximum).Should().BeApproximately(plot.PlotArea.Top + 5, 1e-6);
        yaxis.Transform(yaxis.ActualMinimum).Should().BeApproximately(plot.PlotArea.Bottom - 5 - 10, 1e-6);
        yaxis.Transform(yaxis.ActualMaximum).Should().BeApproximately(plot.PlotArea.Top + 5 + 10, 1e-6);
    }
}
