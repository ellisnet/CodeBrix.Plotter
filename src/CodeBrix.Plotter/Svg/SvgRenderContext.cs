...
public class SvgRenderContext : ClippingRenderContext, IDisposable
{
    ...
    public SvgRenderContext(Stream s, double width, double height, bool isDocument, IRenderContext textMeasurer, PlotterColor background, bool useVerticalTextAlignmentWorkaround = false)
    {
        ...
        {
            this.w.WriteRectangle(0, 0, width, height, this.w.CreateStyle(background, PlotterColors.Undefined, 0), EdgeRenderingMode.Adaptive);
        }
    }
    ...
    /// <inheritdoc/>
    public override void DrawEllipse(PlotterRect rect, PlotterColor fill, PlotterColor stroke, double thickness, EdgeRenderingMode edgeRenderingMode)
    {
    ...
    public override void DrawLine(
        ...
        LineJoin lineJoin)
    {
        this.w.WritePolyline(points, this.w.CreateStyle(PlotterColors.Undefined, stroke, thickness, dashArray, lineJoin), edgeRenderingMode);
    }
    ...
    /// <inheritdoc/>
    public override void DrawRectangle(PlotterRect rect, PlotterColor fill, PlotterColor stroke, double thickness, EdgeRenderingMode edgeRenderingMode)
    {
    ...
    public override PlotterSize MeasureText(string text, string fontFamily, double fontSize, double fontWeight)
    {
        if (string.IsNullOrEmpty(text))
        {
            return PlotterSize.Empty;
        }
    ...
    /// <summary>
    /// Draws the specified portion of the specified <see cref="PlotterImage" /> at the specified location and with the specified size.
    /// </summary>
    ...
    /// <inheritdoc/>
    protected override void SetClip(PlotterRect clippingRectangle)
    {
