...
public class SvgWriter : XmlWriterBase
{
    ...
    /// <param name="image">The image.</param>
    public void WriteImage(double x, double y, double width, double height, PlotterImage image)
    {
    ...
    protected string ColorToString(PlotterColor color)
    {
        if (color.Equals(PlotterColors.Black))
        {
            return "black";
        }
