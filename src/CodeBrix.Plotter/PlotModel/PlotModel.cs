...
public partial class PlotModel : Model, IPlotModel
{
    ...
    public PlotModel()
    {
        ...
        this.PlotMargins = new PlotterThickness(double.NaN);
        this.Padding = new PlotterThickness(8);

        this.Background = PlotterColors.Undefined;
        this.PlotAreaBackground = PlotterColors.Undefined;

        this.TextColor = PlotterColors.Black;
        this.TitleColor = PlotterColors.Automatic;
        this.SubtitleColor = PlotterColors.Automatic;
        ...
        this.PlotAreaBorderColor = PlotterColors.Black;
        this.PlotAreaBorderThickness = new PlotterThickness(1);
        this.EdgeRenderingMode = EdgeRenderingMode.Automatic;

        this.AssignColorsToInvisibleSeries = true;
        this.IsLegendVisible = true;

        this.DefaultColors = new List<PlotterColor>
        {
                PlotterColor.FromRgb(0x4E, 0x9A, 0x06),
                PlotterColor.FromRgb(0xC8, 0x8D, 0x00),
                PlotterColor.FromRgb(0xCC, 0x00, 0x00),
                PlotterColor.FromRgb(0x20, 0x4A, 0x87),
                PlotterColors.Red,
    ...
    public PlotterThickness ActualPlotMargins { get; private set; }
    ...
    /// </summary>
    /// <value>The color. The default is <see cref="PlotterColors.Undefined" />.</value>
    ...
    public PlotterColor Background { get; set; }
    ...
    public IList<PlotterColor> DefaultColors { get; set; }

    /// <summary>
    /// Gets or sets the edge rendering mode that is used for rendering the plot bounds and backgrounds.
    /// </summary>
    /// <value>The edge rendering mode. The default is <see cref="CodeBrix.Plotter.EdgeRenderingMode.Automatic"/>.</value>
    ...
    public PlotterThickness Padding { get; set; }

    /// <summary>
    /// Gets the PlotBounds of the plot (in device units).
    /// </summary>
    public PlotterRect PlotBounds { get; private set; }
    ...
    /// </summary>
    public PlotterThickness PlotMargins { get; set; }
    ...
    public PlotterColor TextColor { get; set; }
    ...
    public PlotterColor SubtitleColor { get; set; }
    ...
    public PlotterRect TitleArea { get; private set; }
    ...
    public PlotterColor GetDefaultColor()
    {
