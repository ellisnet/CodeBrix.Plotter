// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PlotElementUtilities.cs" company="OxyPlot">
...
public static class PlotElementUtilities
{
    ...
    public static PlotterRect GetClippingRect(IXyAxisPlotElement element)
    {
        var xrect = new PlotterRect(element.XAxis.ScreenMin, element.XAxis.ScreenMax);
        var yrect = new PlotterRect(element.YAxis.ScreenMin, element.YAxis.ScreenMax);
