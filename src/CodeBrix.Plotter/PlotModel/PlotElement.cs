...
public abstract class PlotElement : Element, IPlotElement
{
    ...
    protected PlotElement()
    {
        ...
        this.TextColor = PlotterColors.Automatic;
        this.EdgeRenderingMode = EdgeRenderingMode.Automatic;
    }

    /// <summary>
    /// Gets or sets the font. The default is <c>null</c> (use <see cref="CodeBrix.Plotter.PlotModel.DefaultFont" />.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the size of the font. The default is <c>double.NaN</c> (use <see cref="CodeBrix.Plotter.PlotModel.DefaultFontSize" />).
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the color of the text. The default is <c>PlotterColors.Automatic</c> (use <see cref="CodeBrix.Plotter.PlotModel.TextColor" />).
    /// </summary>
    /// <value>The color of the text.</value>
    /// <remarks>If the value is <c>PlotterColors.Automatic</c>, the TextColor of the parent PlotModel will be used.</remarks>
    ...
    protected internal PlotterColor ActualTextColor
    {
        get
        {
    ...
    /// <inheritdoc/>
    public virtual PlotterRect GetClippingRect()
    {
