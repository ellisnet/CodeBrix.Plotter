...
{
    /// <summary>
    /// Converts the specified <see cref="PlotterImage" /> to a <see cref="PortableDocumentImage" />.
    /// </summary>
    /// <param name="image">The source image.</param>
    /// <param name="interpolate">interpolate if set to <c>true</c>.</param>
    /// <returns>The converted image.</returns>
    public static PortableDocumentImage Convert(PlotterImage image, bool interpolate)
    {
        PlotterColor[,] pixels;
        try
        {
