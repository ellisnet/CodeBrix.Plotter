...
public class PdfRenderContext : ClippingRenderContext
{
    ...
    /// The image cache.
    /// </summary>
    private readonly Dictionary<PlotterImage, PortableDocumentImage> images = new Dictionary<PlotterImage, PortableDocumentImage>();
    ...
    public PdfRenderContext(double width, double height, PlotterColor background)
    {
    ...
    /// <summary>
    /// Converts the specified <see cref="CodeBrix.Plotter.LineJoin" /> to a <see cref="CodeBrix.Plotter.LineJoin" />.
    /// </summary>
