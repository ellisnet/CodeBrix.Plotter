...
// </copyright>
// <summary>
//   Provides CodeBrix.Plotter extension methods for <see cref="PortableDocument" />.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
public static class PortableDocumentExtensions
{
    ...
    public static void SetColor(this PortableDocument doc, PlotterColor c)
    {
    ...
    /// <param name="doc">The document.</param>
    /// <param name="c">The color.</param>
    public static void SetFillColor(this PortableDocument doc, PlotterColor c)
    {
