// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LegendBase.cs" company="OxyPlot">
...
public abstract class LegendBase : PlotElement
{
    ...
    public PlotterColor LegendTitleColor { get; set; }
    ...
    /// <remarks>If this value is <c>null</c>, the TextColor will be used.</remarks>
    public PlotterColor LegendTextColor { get; set; }
    ...
    public abstract PlotterSize GetLegendSize(IRenderContext rc, PlotterSize availableLegendArea);
    ...
    public abstract PlotterRect GetLegendRectangle(PlotterSize legendSize);
