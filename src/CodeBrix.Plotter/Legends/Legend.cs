...
public partial class Legend : LegendBase
{
    ...
    public Legend()
    {
        ...
        this.legendBox = new PlotterRect();
        this.Key = null;
        ...
        this.LegendBackground = PlotterColors.Undefined;
        this.LegendBorder = PlotterColors.Undefined;
        this.LegendBorderThickness = 1;

        this.LegendTextColor = PlotterColors.Automatic;
        this.LegendTitleColor = PlotterColors.Automatic;
        ...
        this.SeriesInvisibleTextColor = PlotterColor.FromAColor(64, this.LegendTextColor);

        this.SeriesPosMap = new Dictionary<Series.Series, PlotterRect>();
    ...
    protected override HitTestResult LegendHitTest(HitTestArguments args)
    {
        ...
        if (this.IsPointInLegend(point))
        {
            ...
            {
                foreach (KeyValuePair<Series.Series, PlotterRect> kvp in this.SeriesPosMap)
                {
    ...
    private Dictionary<Series.Series, PlotterRect> SeriesPosMap { get; set; }

    /// <summary>
    /// Gets or sets the textcolor of invisible series.
    /// </summary>
    public PlotterColor SeriesInvisibleTextColor { get; set; }
