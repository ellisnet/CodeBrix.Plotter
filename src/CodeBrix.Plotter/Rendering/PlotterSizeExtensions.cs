// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PlotterSizeExtensions.cs" company="OxyPlot">
//   Copyright (c) 2014 OxyPlot contributors
// </copyright>
// <summary>
//   Provides extension methods for <see cref="PlotterSize" />.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
/// Provides extension methods for <see cref="PlotterSize"/>
/// </summary>
/// <remarks>These are pure methods. They could also be placed in the <see cref="PlotterSize" /> type with a PureAttribute.</remarks>
public static class PlotterSizeExtensions
{
    /// <summary>
    ...
    public static PlotterRect GetBounds(this PlotterSize bounds, double angle, HorizontalAlignment horizontalAlignment, VerticalAlignment verticalAlignment)
    {
        ...
        if (angle == 0)
        {
            return new PlotterRect(-origin.X, -origin.Y, bounds.Width, bounds.Height);
        }
        ...
        return new PlotterRect(x, y, w, h);
    }
    ...
    public static IEnumerable<ScreenPoint> GetPolygon(this PlotterSize size, ScreenPoint origin, double angle, HorizontalAlignment horizontalAlignment, VerticalAlignment verticalAlignment)
    {
        var u = horizontalAlignment == HorizontalAlignment.Left ? 0 : horizontalAlignment == HorizontalAlignment.Center ? 0.5 : 1;
        var v = verticalAlignment == VerticalAlignment.Top ? 0 : verticalAlignment == VerticalAlignment.Middle ? 0.5 : 1;
