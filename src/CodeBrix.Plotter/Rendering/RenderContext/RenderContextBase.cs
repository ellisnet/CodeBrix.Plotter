...
public abstract class RenderContextBase : IRenderContext
{
    ...
    /// <inheritdoc/>
    public virtual void DrawEllipse(PlotterRect rect, PlotterColor fill, PlotterColor stroke, double thickness, EdgeRenderingMode edgeRenderingMode)
    {
    ...
    /// <inheritdoc/>
    public virtual void DrawEllipses(IList<PlotterRect> rectangles, PlotterColor fill, PlotterColor stroke, double thickness, EdgeRenderingMode edgeRenderingMode)
    {
    ...
    /// <inheritdoc/>
    public virtual void DrawRectangle(PlotterRect rect, PlotterColor fill, PlotterColor stroke, double thickness, EdgeRenderingMode edgeRenderingMode)
    {
    ...
    /// <inheritdoc/>
    public virtual void DrawRectangles(IList<PlotterRect> rectangles, PlotterColor fill, PlotterColor stroke, double thickness, EdgeRenderingMode edgeRenderingMode)
    {
        foreach (var r in rectangles)
        {
    ...
    public abstract PlotterSize MeasureText(string text, string fontFamily, double fontSize, double fontWeight);
    ...
    /// <inheritdoc/>
    public abstract void PushClip(PlotterRect clippingRectangle);
    ...
    protected static ScreenPoint[] CreateEllipse(PlotterRect rect, int n = 40)
    {
    ...
    protected static ScreenPoint[] CreateRectangle(PlotterRect rect)
    {
        return new[]
                   {
