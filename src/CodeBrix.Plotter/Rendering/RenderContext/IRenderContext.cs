...
public interface IRenderContext
{
    ...
    /// <param name="fill">The fill color. If set to <c>PlotterColors.Undefined</c>, the extents will not be filled.</param>
    /// <param name="stroke">The stroke color. If set to <c>PlotterColors.Undefined</c>, the extents will not be stroked.</param>
    /// <param name="thickness">The thickness (in device independent units, 1/96 inch).</param>
    /// <param name="edgeRenderingMode">The edge rendering mode.</param>
    void DrawEllipse(PlotterRect extents, PlotterColor fill, PlotterColor stroke, double thickness, EdgeRenderingMode edgeRenderingMode);
    ...
    /// <param name="fill">The fill color. If set to <c>PlotterColors.Undefined</c>, the ellipses will not be filled.</param>
    /// <param name="stroke">The stroke color. If set to <c>PlotterColors.Undefined</c>, the ellipses will not be stroked.</param>
    /// <param name="thickness">The stroke thickness (in device independent units, 1/96 inch).</param>
    /// <param name="edgeRenderingMode">The edge rendering mode.</param>
    /// <remarks>
    /// This should have better performance than calling <see cref="DrawEllipse" /> multiple times.
    /// </remarks>
    void DrawEllipses(IList<PlotterRect> extents, PlotterColor fill, PlotterColor stroke, double thickness, EdgeRenderingMode edgeRenderingMode);
    ...
    /// <param name="fill">The fill color. If set to <c>PlotterColors.Undefined</c>, the polygon will not be filled.</param>
    /// <param name="stroke">The stroke color. If set to <c>PlotterColors.Undefined</c>, the polygon will not be stroked.</param>
    /// <param name="thickness">The stroke thickness (in device independent units, 1/96 inch).</param>
    /// <param name="edgeRenderingMode">The edge rendering mode.</param>
    /// <param name="dashArray">The dash array (in device independent units, 1/96 inch).</param>
    /// <param name="lineJoin">The line join type.</param>
    ...
    /// <param name="fill">The fill color. If set to <c>PlotterColors.Undefined</c>, the polygons will not be filled.</param>
    /// <param name="stroke">The stroke color. If set to <c>PlotterColors.Undefined</c>, the polygons will not be stroked.</param>
    /// <param name="thickness">The stroke thickness (in device independent units, 1/96 inch).</param>
    /// <param name="edgeRenderingMode">The edge rendering mode.</param>
    /// <param name="dashArray">The dash array (in device independent units, 1/96 inch).</param>
    /// <param name="lineJoin">The line join type.</param>
    ...
    /// <param name="fill">The fill color. If set to <c>PlotterColors.Undefined</c>, the rectangle will not be filled.</param>
    /// <param name="stroke">The stroke color. If set to <c>PlotterColors.Undefined</c>, the rectangle will not be stroked.</param>
    /// <param name="thickness">The stroke thickness (in device independent units, 1/96 inch).</param>
    /// <param name="edgeRenderingMode">The edge rendering mode.</param>
    void DrawRectangle(PlotterRect rectangle, PlotterColor fill, PlotterColor stroke, double thickness, EdgeRenderingMode edgeRenderingMode);
    ...
    /// </remarks>
    void DrawRectangles(IList<PlotterRect> rectangles, PlotterColor fill, PlotterColor stroke, double thickness, EdgeRenderingMode edgeRenderingMode);
    ...
    PlotterSize MeasureText(string text, string fontFamily = null, double fontSize = 10, double fontWeight = 500);
    ...
    /// <summary>
    /// Draws a portion of the specified <see cref="PlotterImage" />.
    /// </summary>
    ...
    void DrawImage(PlotterImage source, double srcX, double srcY, double srcWidth, double srcHeight, double destX, double destY, double destWidth, double destHeight, double opacity, bool interpolate);
    ...
    /// It is recommended to use <see cref="RenderingExtensions.AutoResetClip(IRenderContext, PlotterRect)"/> in combination with a <c>using</c> statement instead of <see cref="PushClip(PlotterRect)"/> and <see cref="PopClip"/> if possible.
    /// However if <see cref="PushClip(PlotterRect)"/> and <see cref="PopClip"/> are used directly, it is recommended to wrap them in a try...finally block.
    /// </remarks>
