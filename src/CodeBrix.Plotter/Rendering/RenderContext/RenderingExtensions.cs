...
public static class RenderingExtensions
{
    ...
    */
    ...
    public static void DrawMultilineText(this IRenderContext rc, ScreenPoint point, string text, PlotterColor color, string fontFamily = null, double fontSize = 10, double fontWeight = FontWeights.Normal, double dy = 12)
    {
    ...
    public static void DrawLine(
        this IRenderContext rc, double x0, double y0, double x1, double y1, PlotterPen pen, EdgeRenderingMode edgeRenderingMode)
    {
        if (pen == null)
        {
            return;
    ...
    public static void DrawLineSegments(
        this IRenderContext rc, IList<ScreenPoint> points, PlotterPen pen, EdgeRenderingMode edgeRenderingMode)
    {
        if (pen == null)
        {
            return;
    ...
    public static void DrawMarkers(
        ...
        double markerSize,
        PlotterColor markerFill,
        PlotterColor markerStroke,
        ...
        ScreenPoint binOffset = new ScreenPoint())
    {
        ...
        var ellipses = new List<PlotterRect>(n);
        var rects = new List<PlotterRect>(n);
    ...
    /// <param name="edgeRenderingMode">The edge rendering mode.</param>
    public static void DrawCircle(this IRenderContext rc, double x, double y, double r, PlotterColor fill, PlotterColor stroke, double thickness, EdgeRenderingMode edgeRenderingMode)
    {
        rc.DrawEllipse(new PlotterRect(x - r, y - r, r * 2, r * 2), fill, stroke, thickness, edgeRenderingMode);
    }
    ...
    /// <param name="thickness">The thickness.</param>
    /// <param name="edgeRenderingMode">The edge rendering mode.</param>
    public static void DrawCircle(this IRenderContext rc, ScreenPoint center, double r, PlotterColor fill, PlotterColor stroke, double thickness, EdgeRenderingMode edgeRenderingMode)
    {
    ...
    /// <param name="fill">The fill color.</param>
    /// <param name="edgeRenderingMode">The edge rendering mode.</param>
    public static void FillCircle(this IRenderContext rc, ScreenPoint center, double r, PlotterColor fill, EdgeRenderingMode edgeRenderingMode)
    {
        DrawCircle(rc, center.X, center.Y, r, fill, PlotterColors.Undefined, 0d, edgeRenderingMode);
    }
    ...
    /// <param name="fill">The fill color.</param>
    /// <param name="edgeRenderingMode">The edge rendering mode.</param>
    public static void FillRectangle(this IRenderContext rc, PlotterRect rectangle, PlotterColor fill, EdgeRenderingMode edgeRenderingMode)
    {
        rc.DrawRectangle(rectangle, fill, PlotterColors.Undefined, 0d, edgeRenderingMode);
    }
    ...
    /// <param name="thickness">The thickness.</param>
    /// <param name="edgeRenderingMode">The edge rendering mode.</param>
    public static void DrawRectangle(this IRenderContext rc, PlotterRect rect, PlotterColor stroke, PlotterThickness thickness, EdgeRenderingMode edgeRenderingMode)
    {
        if (thickness.Left.Equals(thickness.Right) && thickness.Left.Equals(thickness.Top) && thickness.Left.Equals(thickness.Bottom))
        {
            rc.DrawRectangle(rect, PlotterColors.Undefined, stroke, thickness.Left, edgeRenderingMode);
            return;
        }
    ...
    public static PlotterSize MeasureText(this IRenderContext rc, string text, string fontFamily, double fontSize, double fontWeight, double angle)
    {
    ...
    public static IDisposable AutoResetClip(this IRenderContext rc, PlotterRect clippingRectangle)
    {
    ...
    private static void AddMarkerGeometry(
        ...
        double size,
        IList<PlotterRect> ellipses,
        IList<PlotterRect> rects,
        ...
        IList<ScreenPoint> lines)
    {
        ...
        switch (type)
        {
            case MarkerType.Circle:
                {
                    ellipses.Add(new PlotterRect(p.x - size, p.y - size, size * 2, size * 2));
                    break;
                }

            case MarkerType.Square:
                {
                    rects.Add(new PlotterRect(p.x - size, p.y - size, size * 2, size * 2));
                    break;
                }
    ...
    private static PlotterSize MeasureRotatedRectangleBound(PlotterSize bounds, double angle)
    {
        var oxyRect = bounds.GetBounds(angle, HorizontalAlignment.Center, VerticalAlignment.Middle);
        return new PlotterSize(oxyRect.Width, oxyRect.Height);
    }
    ...
    /// <summary>
    /// Represents the token that is used to automatically reset the clipping in the <see cref="AutoResetClip(IRenderContext, PlotterRect)"/> method.
    /// </summary>
    private class AutoResetClipToken : IDisposable
    {
        private readonly IRenderContext renderContext;

        public AutoResetClipToken(IRenderContext renderContext, PlotterRect clippingRectangle)
        {
