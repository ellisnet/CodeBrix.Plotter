// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PlotterColor.cs" company="OxyPlot">
...
/// Describes a color in terms of alpha, red, green, and blue channels.
/// </summary>
public struct PlotterColor : ICodeGenerating, IEquatable<PlotterColor>
{
    /// <summary>
    /// The red component.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PlotterColor"/> struct.
    /// </summary>
    /// <param name="a">The alpha value.</param>
    /// <param name="r">The red value.</param>
    /// <param name="g">The green value.</param>
    /// <param name="b">The blue value.</param>
    private PlotterColor(byte a, byte r, byte g, byte b)
    {
        this.a = a;
        this.r = r;
        this.g = g;
    ...
    public static PlotterColor Parse(string value)
    {
        ...
        {
            return PlotterColors.Automatic;
        }
    ...
    /// <summary>
    /// Calculates the difference between two <see cref="PlotterColor" />s
    /// </summary>
    /// <param name="c1">The first color.</param>
    /// <param name="c2">The second color.</param>
    /// <returns>L2-norm in ARGB space</returns>
    public static double ColorDifference(PlotterColor c1, PlotterColor c2)
    {
        // http://en.wikipedia.org/wiki/PlotterColor_difference
    ...
    /// <summary>
    /// Convert an <see cref="uint" /> to a <see cref="PlotterColor" />.
    /// </summary>
    /// <param name="color">The unsigned integer color value.</param>
    /// <returns>The <see cref="PlotterColor" />.</returns>
    public static PlotterColor FromUInt32(uint color)
    {
        var a = (byte)(color >> 24);
        var r = (byte)(color >> 16);
        var g = (byte)(color >> 8);
    ...
    /// <summary>
    /// Creates a PlotterColor from the specified HSV array.
    /// </summary>
    /// <param name="hsv">The HSV value array.</param>
    /// <returns>A PlotterColor.</returns>
    public static PlotterColor FromHsv(double[] hsv)
    {
        if (hsv.Length != 3)
        {
    ...
    /// <summary>
    /// Converts from HSV to <see cref="PlotterColor" />
    /// </summary>
    ...
    public static PlotterColor FromHsv(double hue, double sat, double val)
    {
        double g, b;
        double r = g = b = 0;
    ...
    /// <summary>
    /// Calculate the difference in hue between two <see cref="PlotterColor" />s.
    /// </summary>
    /// <param name="c1">The first color.</param>
    /// <param name="c2">The second color.</param>
    /// <returns>The hue difference.</returns>
    public static double HueDifference(PlotterColor c1, PlotterColor c2)
    {
        var hsv1 = c1.ToHsv();
        var hsv2 = c2.ToHsv();
    ...
    public static PlotterColor FromAColor(byte a, PlotterColor color)
    {
    ...
    /// <param name="b">The blue value.</param>
    /// <returns>A color.</returns>
    public static PlotterColor FromArgb(byte a, byte r, byte g, byte b)
    {
        return new PlotterColor(a, r, g, b);
    }

    /// <summary>
    /// Creates a new <see cref="PlotterColor" /> structure from the specified RGB values.
    /// </summary>
    /// <param name="r">The red value.</param>
    /// <param name="g">The green value.</param>
    /// <param name="b">The blue value.</param>
    /// <returns>A <see cref="PlotterColor" /> structure with the specified values and an alpha channel value of 1.</returns>
    public static PlotterColor FromRgb(byte r, byte g, byte b)
    {
        // ReSharper restore InconsistentNaming
        return new PlotterColor(255, r, g, b);
    }
    ...
    public static PlotterColor Interpolate(PlotterColor color1, PlotterColor color2, double t)
    {
    ...
    public static bool operator ==(PlotterColor first, PlotterColor second)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        if (obj.GetType() != typeof(PlotterColor))
        {
            return false;
        }

        return this.Equals((PlotterColor)obj);
    }

    /// <summary>
    /// Determines whether the specified <see cref="PlotterColor" /> is equal to this instance.
    /// </summary>
    /// <param name="other">The <see cref="PlotterColor" /> to compare with this instance.</param>
    /// <returns><c>true</c> if the specified <see cref="PlotterColor" /> is equal to this instance; otherwise, <c>false</c> .</returns>
    public bool Equals(PlotterColor other)
    {
    ...
    /// </summary>
    /// <returns><c>True</c> if the color equals <see cref="PlotterColors.Undefined" />.</returns>
    public bool IsUndefined()
    {
        return this.Equals(PlotterColors.Undefined);
    }

    /// <summary>
    /// Determines whether this color is automatic.
    /// </summary>
    /// <returns><c>True</c> if the color equals <see cref="PlotterColors.Automatic" />.</returns>
    public bool IsAutomatic()
    {
        return this.Equals(PlotterColors.Automatic);
    }
    ...
    /// <returns>The default color if the current color equals PlotterColors.Automatic, otherwise the color itself.</returns>
    public PlotterColor GetActualColor(PlotterColor defaultColor)
    {
