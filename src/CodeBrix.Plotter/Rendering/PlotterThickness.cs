// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PlotterThickness.cs" company="OxyPlot">
...
/// Describes the thickness of a frame around a rectangle. Four <see cref="System.Double" /> values describe the left, top, right, and bottom sides of the rectangle, respectively.
/// </summary>
public struct PlotterThickness : ICodeGenerating
{
    /// <summary>
    /// The bottom.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PlotterThickness" /> struct.
    /// </summary>
    /// <param name="thickness">The thickness.</param>
    public PlotterThickness(double thickness)
    ...
    public PlotterThickness(double left, double top, double right, double bottom)
    {
        this.left = left;
        this.top = top;
        this.right = right;
    ...
    /// <summary>
    /// Determines whether this instance and another specified <see cref="T:PlotterThickness" /> object have the same value.
    /// </summary>
    ...
    public bool Equals(PlotterThickness other)
    {
    ...
    /// <summary>
    /// Creates a new <see cref="PlotterThickness"/> with the maximum dimensions of this instance and the specified other instance.
    /// </summary>
    /// <param name="other">The other instance.</param>
    /// <returns>A new <see cref="PlotterThickness"/>.</returns>
    public PlotterThickness Include(PlotterThickness other)
    {
        return new PlotterThickness(Math.Max(other.Left, this.Left), Math.Max(other.Top, this.Top), Math.Max(other.Right, this.Right), Math.Max(other.Bottom, this.Bottom));
    }
}
