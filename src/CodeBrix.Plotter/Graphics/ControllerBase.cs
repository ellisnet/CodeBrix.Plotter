...
public abstract class ControllerBase : IController
{
    ...
    protected ControllerBase()
    {
        ...
        this.MouseDownManipulators = new List<ManipulatorBase<PlotterMouseEventArgs>>();
        this.MouseHoverManipulators = new List<ManipulatorBase<PlotterMouseEventArgs>>();
        this.TouchManipulators = new List<ManipulatorBase<PlotterTouchEventArgs>>();
    }
    ...
    /// </summary>
    protected IList<ManipulatorBase<PlotterMouseEventArgs>> MouseDownManipulators { get; private set; }
    ...
    /// </summary>
    protected IList<ManipulatorBase<PlotterMouseEventArgs>> MouseHoverManipulators { get; private set; }
    ...
    /// </summary>
    protected IList<ManipulatorBase<PlotterTouchEventArgs>> TouchManipulators { get; private set; }
    ...
    public virtual bool HandleGesture(IView view, PlotterInputGesture gesture, PlotterInputEventArgs args)
    {
    ...
    /// <returns><c>true</c> if the event was handled.</returns>
    public virtual bool HandleMouseDown(IView view, PlotterMouseDownEventArgs args)
    {
        lock (this.GetSyncRoot(view))
        {
            var command = this.GetCommand(new PlotterMouseDownGesture(args.ChangedButton, args.ModifierKeys, args.ClickCount));
            return this.HandleCommand(command, view, args);
        }
    }
    ...
    /// <param name="args">The <see cref="PlotterMouseEventArgs" /> instance containing the event data.</param>
    /// <returns><c>true</c> if the event was handled.</returns>
    public virtual bool HandleMouseEnter(IView view, PlotterMouseEventArgs args)
    {
        lock (this.GetSyncRoot(view))
        {
            var command = this.GetCommand(new PlotterMouseEnterGesture(args.ModifierKeys));
            return this.HandleCommand(command, view, args);
        }
    }
    ...
    /// <param name="args">The <see cref="PlotterMouseEventArgs" /> instance containing the event data.</param>
    /// <returns><c>true</c> if the event was handled.</returns>
    public virtual bool HandleMouseLeave(IView view, PlotterMouseEventArgs args)
    {
        lock (this.GetSyncRoot(view))
        {
    ...
    /// <param name="args">The <see cref="PlotterMouseEventArgs" /> instance containing the event data.</param>
    /// <returns><c>true</c> if the event was handled.</returns>
    public virtual bool HandleMouseMove(IView view, PlotterMouseEventArgs args)
    {
        lock (this.GetSyncRoot(view))
        {
    ...
    /// <param name="args">The <see cref="PlotterMouseEventArgs" /> instance containing the event data.</param>
    /// <returns><c>true</c> if the event was handled.</returns>
    public virtual bool HandleMouseUp(IView view, PlotterMouseEventArgs args)
    {
        lock (this.GetSyncRoot(view))
        {
    ...
    /// <returns><c>true</c> if the event was handled.</returns>
    public virtual bool HandleMouseWheel(IView view, PlotterMouseWheelEventArgs args)
    {
        lock (this.GetSyncRoot(view))
        {
            var command = this.GetCommand(new PlotterMouseWheelGesture(args.ModifierKeys));
            return this.HandleCommand(command, view, args);
        }
    }
    ...
    /// <returns><c>true</c> if the event was handled.</returns>
    public virtual bool HandleTouchStarted(IView view, PlotterTouchEventArgs args)
    {
        lock (this.GetSyncRoot(view))
        {
            var command = this.GetCommand(new PlotterTouchGesture());
            return this.HandleCommand(command, view, args);
        }
    }
    ...
    /// <param name="args">The <see cref="PlotterTouchEventArgs" /> instance containing the event data.</param>
    /// <returns><c>true</c> if the event was handled.</returns>
    public virtual bool HandleTouchDelta(IView view, PlotterTouchEventArgs args)
    {
        lock (this.GetSyncRoot(view))
        {
    ...
    /// <param name="args">The <see cref="PlotterTouchEventArgs" /> instance containing the event data.</param>
    /// <returns><c>true</c> if the event was handled.</returns>
    public virtual bool HandleTouchCompleted(IView view, PlotterTouchEventArgs args)
    {
        lock (this.GetSyncRoot(view))
        {
    ...
    /// <returns><c>true</c> if the event was handled.</returns>
    public virtual bool HandleKeyDown(IView view, PlotterKeyEventArgs args)
    {
        lock (this.GetSyncRoot(view))
        {
            ...
            var command = this.GetCommand(new PlotterKeyGesture(args.Key, args.ModifierKeys));
            return this.HandleCommand(command, view, args);
        }
    }
    ...
    /// <param name="args">The <see cref="PlotterMouseDownEventArgs" /> instance containing the event data.</param>
    public virtual void AddMouseManipulator(
        IView view,
        ManipulatorBase<PlotterMouseEventArgs> manipulator,
        PlotterMouseDownEventArgs args)
    {
    ...
    public virtual void AddTouchManipulator(
        IView view,
        ManipulatorBase<PlotterTouchEventArgs> manipulator,
        PlotterTouchEventArgs args)
    {
    ...
    public virtual void Bind(PlotterMouseDownGesture gesture, IViewCommand<PlotterMouseDownEventArgs> command)
    {
    ...
    /// <param name="gesture">The gesture.</param>
    /// <param name="command">The command. If <c>null</c>, the binding will be removed.</param>
    public virtual void Bind(PlotterMouseEnterGesture gesture, IViewCommand<PlotterMouseEventArgs> command)
    {
        this.BindCore(gesture, command);
    }
    ...
    /// <param name="gesture">The gesture.</param>
    /// <param name="command">The command. If <c>null</c>, the binding will be removed.</param>
    public virtual void Bind(PlotterMouseWheelGesture gesture, IViewCommand<PlotterMouseWheelEventArgs> command)
    {
        this.BindCore(gesture, command);
    }
    ...
    /// <param name="gesture">The gesture.</param>
    /// <param name="command">The command. If <c>null</c>, the binding will be removed.</param>
    public virtual void Bind(PlotterTouchGesture gesture, IViewCommand<PlotterTouchEventArgs> command)
    {
        this.BindCore(gesture, command);
    }
    ...
    /// <param name="gesture">The gesture.</param>
    /// <param name="command">The command. If <c>null</c>, the binding will be removed.</param>
    public virtual void Bind(PlotterKeyGesture gesture, IViewCommand<PlotterKeyEventArgs> command)
    {
        this.BindCore(gesture, command);
    }
    ...
    public virtual void Unbind(PlotterInputGesture gesture)
    {
    ...
    protected void BindCore(PlotterInputGesture gesture, IViewCommand command)
    {
    ...
    /// <summary>
    /// Gets the command for the specified <see cref="PlotterInputGesture" />.
    /// </summary>
    /// <param name="gesture">The input gesture.</param>
    /// <returns>A command.</returns>
    protected virtual IViewCommand GetCommand(PlotterInputGesture gesture)
    {
    ...
    protected virtual bool HandleCommand(IViewCommand command, IView view, PlotterInputEventArgs args)
    {
        if (command == null)
        {
            return false;
