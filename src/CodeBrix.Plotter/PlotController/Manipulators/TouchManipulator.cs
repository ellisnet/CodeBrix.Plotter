...
/// Provides a manipulator for panning and scaling by touch events.
/// </summary>
public class TouchManipulator : PlotManipulator<PlotterTouchEventArgs>
{
    /// <summary>
    ...
    /// </summary>
    /// <param name="e">The <see cref="CodeBrix.Plotter.PlotterTouchEventArgs" /> instance containing the event data.</param>
