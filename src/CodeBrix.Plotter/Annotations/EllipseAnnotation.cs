...
public class EllipseAnnotation : ShapeAnnotation
{
    ...
    /// </summary>
    private PlotterRect screenRectangle;
    ...
    public override void Render(IRenderContext rc)
    {
        ...
        this.screenRectangle = new PlotterRect(this.Transform(this.X - (this.Width / 2), this.Y - (this.Height / 2)), this.Transform(this.X + (this.Width / 2), this.Y + (this.Height / 2)));
