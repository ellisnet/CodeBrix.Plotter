...
public class LineSeries : DataPointSeries
{
    ...
    /// The default color.
    /// </summary>
    private PlotterColor defaultColor;

    /// <summary>
    /// The default marker fill color.
    /// </summary>
    private PlotterColor defaultMarkerFill;
    ...
    public LineSeries()
    {
        ...
        this.BrokenLineColor = PlotterColors.Undefined;

        this.MarkerFill = PlotterColors.Automatic;
        this.MarkerStroke = PlotterColors.Automatic;
    ...
    /// <summary>
    /// Gets or sets the color of the broken line segments. The default is <see cref="PlotterColors.Undefined"/>. Set it to <see cref="PlotterColors.Automatic"/> if it should follow the <see cref="Color" />.
    /// </summary>
    /// <remarks>Add <c>DataPoint.Undefined</c> in the Points collection to create breaks in the line.</remarks>
    public PlotterColor BrokenLineColor { get; set; }

    /// <summary>
    /// Gets or sets the broken line style. The default is <see cref="CodeBrix.Plotter.LineStyle.Solid" />.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the line join. The default is <see cref="CodeBrix.Plotter.LineJoin.Bevel" />.
    /// </summary>
    /// <value>The line join.</value>
    public LineJoin LineJoin { get; set; }

    /// <summary>
    /// Gets or sets the line style. The default is <see cref="CodeBrix.Plotter.LineStyle.Automatic" />.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the marker fill color. The default is <see cref="PlotterColors.Automatic" />.
    /// </summary>
    /// <value>The marker fill.</value>
    public PlotterColor MarkerFill { get; set; }

    /// <summary>
    /// Gets or sets the a custom polygon outline for the markers. Set <see cref="MarkerType" /> to <see cref="CodeBrix.Plotter.MarkerType.Custom" /> to use this property. The default is <c>null</c>.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the marker stroke. The default is <c>PlotterColors.Automatic</c>.
    /// </summary>
    /// <value>The marker stroke.</value>
    public PlotterColor MarkerStroke { get; set; }
    ...
    public PlotterColor ActualColor
    {
        get
        {
    ...
    /// </summary>
    /// <value>The actual color.</value>
    public PlotterColor ActualMarkerFill
    {
        get
        {
