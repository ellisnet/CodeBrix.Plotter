...
public class VectorSeries : XYAxisSeries
{
    ...
    private void DrawVector(IRenderContext rc, DataPoint point, DataVector vector, PlotterColor color)
    {
    ...
    private void DrawArrow(IRenderContext rc, IList<ScreenPoint> points, ScreenVector direction, PlotterColor color)
    {
