...
public class TwoColorAreaSeries : AreaSeries
{
    ...
    /// </summary>
    private PlotterColor defaultColor2;
    ...
    {
        this.Color2 = PlotterColors.Blue;

        this.Fill = PlotterColors.Automatic;
        this.Fill2 = PlotterColors.Automatic;

        this.MarkerFill2 = PlotterColors.Automatic;
        this.MarkerStroke2 = PlotterColors.Automatic;
    ...
    public PlotterColor Fill2 { get; set; }

    /// <summary>
    /// Gets the actual fill color below the limit line.
    /// </summary>
    /// <value>The actual fill below the limit line.</value>
    public PlotterColor ActualFill2
    {
        get
        {
            return this.Fill2.GetActualColor(PlotterColor.FromAColor(100, this.ActualColor2));
        }
    }
    ...
    public override PlotterColor ActualColor2
    {
    ...
    /// <summary>
    /// Gets or sets the marker fill color which is below the limit line. The default is <see cref="PlotterColors.Automatic" />.
    /// </summary>
    /// <value>The marker fill.</value>
    public PlotterColor MarkerFill2 { get; set; }

    /// <summary>
    /// Gets or sets the marker stroke which is below the limit line. The default is <c>PlotterColors.Automatic</c>.
    /// </summary>
    /// <value>The marker stroke.</value>
    public PlotterColor MarkerStroke2 { get; set; }
