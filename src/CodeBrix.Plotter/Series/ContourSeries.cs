...
public class ContourSeries : XYAxisSeries
{
    ...
    public ContourSeries()
    {
        ...
        this.LabelBackground = PlotterColor.FromAColor(220, PlotterColors.White);
    ...
    public PlotterColor[] ContourColors { get; set; }
    ...
    public PlotterColor LabelBackground { get; set; }
    ...
    private void RenderLabelBackground(IRenderContext rc, ContourLabel cl)
    {
        ...
        rc.DrawPolygon(bpts, this.LabelBackground, PlotterColors.Undefined, 0, this.EdgeRenderingMode);
    }
