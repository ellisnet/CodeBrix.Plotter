...
public class HistogramItem : ICodeGenerating
{
    ...
    public HistogramItem(double rangeStart, double rangeEnd, double area, int count)
        : this(rangeStart, rangeEnd, area, count, PlotterColors.Automatic)
    {
    }
    ...
    public HistogramItem(double rangeStart, double rangeEnd, double area, int count, PlotterColor color)
    {
