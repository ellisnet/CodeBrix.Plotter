...
public class ExtrapolationLineSeries : LineSeries
{
    ...
    /// </summary>
    private readonly PlotterColor defaultExtrapolationColor = PlotterColors.Black;
    ...
    {
        this.ExtrapolationColor = PlotterColors.Black;
    ...
    /// </summary>
    public PlotterColor ExtrapolationColor { get; set; }

    /// <summary>
    /// Gets the actual extrapolation color.
    /// </summary>
    /// <value>The actual color.</value>
    public PlotterColor ActualExtrapolationColor => this.ExtrapolationColor.GetActualColor(this.defaultExtrapolationColor);
    ...
    /// </summary>
    private IEnumerable<PlotterRect> CreateClippingRectangles(
        PlotterRect clippingRect, double minX, double maxX, double minY, double maxY)
    {
        var previous = minX;
    ...
    {
        PlotterColor color = isInterval ? this.ExtrapolationColor : this.Color;
