...
public class BarSeries : BarSeriesBase<BarItem>, IStackableSeries
{
    ...
    /// </summary>
    protected IList<PlotterRect> ActualBarRectangles { get; set; }
    ...
    {
        this.ActualBarRectangles = new List<PlotterRect>();
    ...
    protected override bool UpdateFromDataFields()
    {
        ...
        filler.Add(this.ColorField, PlotterColors.Automatic);
        filler.Fill(
            this.ItemsSourceItems,
            this.ItemsSource,
            args => new BarItem(Convert.ToDouble(args[0])) { Color = (PlotterColor)args[1] });
