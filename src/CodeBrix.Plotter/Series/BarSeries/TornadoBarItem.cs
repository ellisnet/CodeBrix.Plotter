...
public class TornadoBarItem : BarItemBase, ICodeGenerating
{
    ...
    public TornadoBarItem()
    {
        ...
        this.MinimumColor = PlotterColors.Automatic;
        this.MaximumColor = PlotterColors.Automatic;
    }
    ...
    /// </summary>
    public PlotterColor MaximumColor { get; set; }
    ...
    /// </summary>
    public PlotterColor MinimumColor { get; set; }
