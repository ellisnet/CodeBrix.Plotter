...
public class IntervalBarSeries : BarSeriesBase<IntervalBarItem>, IStackableSeries
{
    ...
    /// </summary>
    protected internal IList<PlotterRect> ActualBarRectangles { get; set; }
    ...
    public override void Render(IRenderContext rc)
    {
        ...
        for (var i = 0; i < this.ValidItems.Count; i++)
        {
            ...
            var rectangle = new PlotterRect(p0, p1);
    ...
    protected override bool UpdateFromDataFields()
    {
        ...
        filler.Fill(
            ...
            this.ItemsSource,
            args => new IntervalBarItem(Convert.ToDouble(args[0]), Convert.ToDouble(args[1])) { Color = (PlotterColor)args[2] });
