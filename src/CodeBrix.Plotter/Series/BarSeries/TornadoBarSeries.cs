...
public class TornadoBarSeries : BarSeriesBase<TornadoBarItem>
{
    ...
    /// </summary>
    private PlotterColor defaultMaximumFillColor;

    /// <summary>
    /// The default minimum fill color.
    /// </summary>
    private PlotterColor defaultMinimumFillColor;
    ...
    {
        this.MaximumFillColor = PlotterColor.FromRgb(216, 82, 85);
        this.MinimumFillColor = PlotterColor.FromRgb(84, 138, 209);

        this.StrokeColor = PlotterColors.Black;
    ...
    public PlotterColor ActualMaximumFillColor => this.MaximumFillColor.GetActualColor(this.defaultMaximumFillColor);

    /// <summary>
    /// Gets the actual minimum fill color.
    /// </summary>
    /// <value>The actual color.</value>
    public PlotterColor ActualMinimumFillColor => this.MinimumFillColor.GetActualColor(this.defaultMinimumFillColor);
    ...
    public PlotterColor MaximumFillColor { get; set; }
    ...
    /// </summary>
    /// <value>The color.</value>
    public PlotterColor MinimumFillColor { get; set; }
    ...
    /// </summary>
    protected internal IList<PlotterRect> ActualMaximumBarRectangles { get; set; }

    /// <summary>
    /// Gets or sets the actual rectangles for the minimum bars.
    /// </summary>
    protected internal IList<PlotterRect> ActualMinimumBarRectangles { get; set; }
    ...
    {
        this.ActualMinimumBarRectangles = new List<PlotterRect>();
        this.ActualMaximumBarRectangles = new List<PlotterRect>();
        ...
        for (var i = 0; i < this.ValidItems.Count; i++)
        {
            ...
            var minimumRectangle = new PlotterRect(pMin, pBase);
            var maximumRectangle = new PlotterRect(pMax, pBase);
    ...
    /// <inheritdoc/>
    public override void RenderLegend(IRenderContext rc, PlotterRect legendBox)
    {
        ...
        var width = height;
        rc.DrawRectangle(
            new PlotterRect(xmid - (0.5 * width), ymid - (0.5 * height), 0.5 * width, height),
            this.ActualMinimumFillColor,
            this.StrokeColor,
            this.StrokeThickness,
            this.EdgeRenderingMode);
        rc.DrawRectangle(
            new PlotterRect(xmid, ymid - (0.5 * height), 0.5 * width, height),
    ...
    protected override bool UpdateFromDataFields()
    {
        ...
        filler.Add(this.MinimumColorField, PlotterColors.Automatic);
        filler.Add(this.MaximumColorField, PlotterColors.Automatic);
        filler.Fill(
            ...
            args => new TornadoBarItem()
            {
                ...
                MinimumColor = (PlotterColor)args[3],
                MaximumColor = (PlotterColor)args[4],
            });
