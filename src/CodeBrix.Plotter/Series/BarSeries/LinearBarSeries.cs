...
public class LinearBarSeries : DataPointSeries
{
    ...
    /// </summary>
    private readonly List<PlotterRect> rectangles = new List<PlotterRect>();
    ...
    {
        this.FillColor = PlotterColors.Automatic;
        this.BarWidth = 5;
        this.StrokeColor = PlotterColors.Black;
        this.StrokeThickness = 0;
        this.TrackerFormatString = XYAxisSeries.DefaultTrackerFormatString;
        this.NegativeFillColor = PlotterColors.Undefined;
        this.NegativeStrokeColor = PlotterColors.Undefined;
        this.BaseValue = 0;
    ...
    public PlotterColor FillColor { get; set; }
    ...
    public override void RenderLegend(IRenderContext rc, PlotterRect legendBox)
    {
        ...
        var width = height;
        rc.DrawRectangle(
            new PlotterRect(xmid - (0.5 * width), ymid - (0.5 * height), width, height),
    ...
    {
        IComparer<PlotterRect> comparer;
        if (this.IsTransposed())
        {
            comparer = ComparerHelper.CreateComparer<PlotterRect>(
                (x, y) =>
                    {
                        if (x.Bottom < point.Y)
                        {
        ...
        return this.rectangles.BinarySearch(0, this.rectangles.Count, new PlotterRect(), comparer);
    }
    ...
    private void RenderBars(IRenderContext rc, List<DataPoint> actualPoints)
    {
        ...
        for (var pointIndex = 0; pointIndex < actualPoints.Count; pointIndex++)
        {
            ...
            var rectangle = new PlotterRect(basePoint, screenPoint);
    ...
    private struct BarColors
    {
        ...
        public BarColors(PlotterColor fillColor, PlotterColor strokeColor) : this()
        {
        ...
        /// Gets the fill color.
        /// </summary>
        public PlotterColor FillColor { get; private set; }

        /// <summary>
        /// Gets the stroke color.
        /// </summary>
        public PlotterColor StrokeColor { get; private set; }
    }
}
