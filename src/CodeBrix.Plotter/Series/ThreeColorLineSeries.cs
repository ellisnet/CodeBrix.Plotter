...
public class ThreeColorLineSeries : LineSeries
{
    ...
    /// </summary>
    private PlotterColor defaultColorLo;

    /// <summary>
    /// The default hi color.
    /// </summary>
    private PlotterColor defaultColorHi;
    ...
    {
        this.LimitLo = -5.0;
        this.ColorLo = PlotterColors.Blue;
        this.LineStyleLo = LineStyle.Solid;
        this.LimitHi = 5.0;
        this.ColorHi = PlotterColors.Red;
    ...
    /// </summary>
    public PlotterColor ColorLo { get; set; }

    /// <summary>
    /// Gets or sets the color for the part of the line that is above the limit.
    /// </summary>
    public PlotterColor ColorHi { get; set; }

    /// <summary>
    /// Gets the actual hi color.
    /// </summary>
    /// <value>The actual color.</value>
    public PlotterColor ActualColorLo
    {
    ...
    /// </summary>
    /// <value>The actual color.</value>
    public PlotterColor ActualColorHi
    {
    ...
    protected override void RenderLine(IRenderContext rc, IList<ScreenPoint> pointsToRender)
    {
        ...
        void RenderLine(PlotterColor color)
        {
            rc.DrawReducedLine(
                pointsToRender,
