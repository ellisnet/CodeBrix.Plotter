...
public class HistogramSeries : XYAxisSeries
{
    ...
    /// </summary>
    private PlotterColor defaultFillColor;
    ...
    public PlotterColor ActualFillColor => this.FillColor.GetActualColor(this.defaultFillColor);
    ...
    /// </summary>
    public Func<HistogramItem, PlotterColor> ColorMapping { get; set; }
    ...
    protected void RenderBins(IRenderContext rc, ICollection<HistogramItem> items)
    {
        ...
        foreach (var item in items)
        {
            ...
            var rectangle = new PlotterRect(p1, p2);
    ...
    protected PlotterColor GetItemFillColor(HistogramItem item)
    {
    ...
    protected PlotterColor GetItemStrokeColor(HistogramItem item)
    {
    ...
    /// <param name="item">The item.</param>
    protected void RenderLabel(IRenderContext rc, PlotterRect rect, HistogramItem item)
    {
    ...
    private PlotterColor GetDefaultColor(HistogramItem item)
    {
