...
public class CandleStickSeries : HighLowSeries
{
    ...
    {
        this.IncreasingColor = PlotterColors.DarkGreen;
        this.DecreasingColor = PlotterColors.Red;
        this.CandleWidth = 0;
    }
    ...
    /// </summary>
    public PlotterColor IncreasingColor { get; set; }

    /// <summary>
    /// Gets or sets the fill color used when the closing value is less than opening value.
    /// </summary>
    public PlotterColor DecreasingColor { get; set; }
    ...
    public override void Render(IRenderContext rc)
    {
        ...
        for (int i = this.WindowStartIndex; i < nitems; i++)
        {
            ...
            var rect = new PlotterRect(p1, p2);
