...
public class VolumeSeries : XYAxisSeries
{
    ...
    public VolumeSeries()
    {
        this.PositiveColor = PlotterColors.DarkGreen;
        this.NegativeColor = PlotterColors.Red;
        this.BarWidth = 0;
        ...
        this.InterceptColor = PlotterColors.Gray;
    ...
    public override void Render(IRenderContext rc)
    {
        ...
        var barfillUp = this.PositiveHollow ? PlotterColors.Transparent : fillUp;
        var barfillDown = this.NegativeHollow ? PlotterColors.Transparent : fillDown;
                ...
                case VolumeStyle.Combined:
                    {
                        ...
                        var rect1 = new PlotterRect(p1, p2);
                ...
                case VolumeStyle.PositiveNegative:
                    {
                        ...
                        var rectBuy = new PlotterRect(p1, p2Buy);
                        var rectSell = new PlotterRect(p1, p2Bell);
                ...
                case VolumeStyle.Stacked:
                    {
                        ...
                        PlotterRect rectBuy;
                        PlotterRect rectSell;

                        if (bar.BuyVolume > bar.SellVolume)
                        {
                            rectSell = new PlotterRect(p1, p2Sell);
                            rectBuy = new PlotterRect(p2Sell, pBoth);
                        }
                        else
                        {
                            rectBuy = new PlotterRect(p1, p2Buy);
                            rectSell = new PlotterRect(p2Buy, pBoth);
                        }
    ...
    public override void RenderLegend(IRenderContext rc, PlotterRect legendBox)
    {
        ...
        if (this.StrokeThickness > 0)
        {
            ...
            rc.DrawRectangle(
                new PlotterRect(xmid - (candlewidth * 0.5), yclose, candlewidth, yopen - yclose),
                fillUp,
                lineUp,
                this.StrokeThickness,
                this.EdgeRenderingMode);
