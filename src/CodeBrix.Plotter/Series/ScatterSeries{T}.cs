...
public abstract class ScatterSeries<T> : XYAxisSeries where T : ScatterPoint
{
    ...
    /// </summary>
    private PlotterColor defaultMarkerFillColor;
    ...
    /// </summary>
    /// <value>The fill color of the markers. The default is <see cref="PlotterColors.Automatic" />.</value>
    ...
    public PlotterColor ActualMarkerFillColor
    {
    ...
    /// </summary>
    /// <value>The marker stroke. The default is <see cref="PlotterColors.Automatic" />.</value>
    ...
    protected void RenderPointLabels(IRenderContext rc, PlotterRect clippingRect)
    {
        var actualPoints = this.ActualPointsList;
        if (actualPoints == null || actualPoints.Count == 0)
        {
