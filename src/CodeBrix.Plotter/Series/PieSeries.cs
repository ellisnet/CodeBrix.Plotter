...
public class PieSeries : ItemsSeries
{
    ...
    public PieSeries()
    {
        ...
        this.Stroke = PlotterColors.White;
        ...
        this.InsideLabelColor = PlotterColors.Automatic;
    ...
    /// </summary>
    /// <remarks>If the value is <c>PlotterColors.Automatic</c>, the <see cref="PlotElement.TextColor" /> will be used.</remarks>
    public PlotterColor InsideLabelColor { get; set; }
