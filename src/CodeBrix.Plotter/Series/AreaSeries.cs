...
public class AreaSeries : LineSeries
{
    ...
    {
        this.Reverse2 = true;
        this.Color2 = PlotterColors.Automatic;
    ...
    public PlotterColor Color2 { get; set; }

    /// <summary>
    /// Gets the actual color of the line for the second data set.
    /// </summary>
    /// <value>The actual color.</value>
    public virtual PlotterColor ActualColor2
    {
        get
        {
    ...
    public PlotterColor ActualFill
    {
        get
        {
            return this.Fill.GetActualColor(PlotterColor.FromAColor(100, this.ActualColor));
        }
    }
    ...
    public override void RenderLegend(IRenderContext rc, PlotterRect legendBox)
    {
        ...
        rc.DrawPolygon(pts, this.GetSelectableFillColor(this.ActualFill), PlotterColors.Undefined, 0, this.EdgeRenderingMode);
    }
