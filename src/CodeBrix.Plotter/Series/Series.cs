...
public abstract class Series : PlotElement
{
    ...
    /// <summary>
    /// Gets or sets the background color of the series. The default is <c>PlotterColors.Undefined</c>.
    /// </summary>
    ...
    public abstract void RenderLegend(IRenderContext rc, PlotterRect legendBox);
