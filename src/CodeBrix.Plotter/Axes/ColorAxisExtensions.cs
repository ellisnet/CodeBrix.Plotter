...
public static class ColorAxisExtensions
{
    ...
    public static PlotterColor GetColor(this IColorAxis axis, double value)
    {
    ...
    /// <returns>The color.</returns>
    public static PlotterColor GetColor<T>(this T axis, int paletteIndex) where T : Axis, INumericColorAxis
    {
