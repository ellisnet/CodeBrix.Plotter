...
public class AngleAxisFullPlotAreaRenderer : AxisRendererBase<AngleAxisFullPlotArea>
{
    ...
    public override void Render(AngleAxisFullPlotArea axis, int pass)
    {
        ...
        foreach (var value in this.MajorLabelValues.Take(majorTickCount))
        {
            ...
            PlotterRect plotrect = this.Plot.PlotArea;
    ...
    /// <returns></returns>
    public ScreenPoint TransformToClientRectangle(double actualMaximum, double x, Axis axis, PlotterRect plotArea, ScreenPoint midPoint)
    {
