...
public class MagnitudeAxisRenderer : AxisRendererBase<MagnitudeAxis>
{
    ...
    private void RenderTick(MagnitudeAxis axis, AngleAxis angleAxis, double x, PlotterPen pen)
    {
    ...
    /// <param name="x">The x-value.</param>
    /// <param name="pen">The pen.</param>
    private void RenderTickCircle(MagnitudeAxis axis, Axis angleAxis, double x, PlotterPen pen)
    {
        ...
        this.RenderContext.DrawEllipse(new PlotterRect(left, top, width, height), PlotterColors.Undefined, pen.Color, pen.Thickness, axis.EdgeRenderingMode);
    }
    ...
    /// <param name="x">The x-value.</param>
    /// <param name="pen">The pen.</param>
    private void RenderTickArc(MagnitudeAxis axis, AngleAxis angleAxis, double x, PlotterPen pen)
    {
