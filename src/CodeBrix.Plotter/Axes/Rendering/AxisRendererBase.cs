...
public abstract class AxisRendererBase<T> where T: Axis
{
    ...
    /// </summary>
    protected PlotterPen AxislinePen { get; set; }

    /// <summary>
    /// Gets or sets the extra grid lines pen.
    /// </summary>
    protected PlotterPen ExtraPen { get; set; }
    ...
    /// </summary>
    protected PlotterPen MajorPen { get; set; }

    /// <summary>
    /// Gets or sets the major tick pen.
    /// </summary>
    protected PlotterPen MajorTickPen { get; set; }
    ...
    /// </summary>
    protected PlotterPen MinorPen { get; set; }

    /// <summary>
    /// Gets or sets the minor tick pen.
    /// </summary>
    protected PlotterPen MinorTickPen { get; set; }
    ...
    /// </summary>
    protected PlotterPen ZeroPen { get; set; }
    ...
    protected virtual void CreatePens(T axis)
    {
        ...
        this.MinorPen = PlotterPen.Create(axis.MinorGridlineColor, axis.MinorGridlineThickness, axis.MinorGridlineStyle);
        this.MajorPen = PlotterPen.Create(axis.MajorGridlineColor, axis.MajorGridlineThickness, axis.MajorGridlineStyle);
        this.MinorTickPen = PlotterPen.Create(minorTickColor, axis.MinorGridlineThickness);
        this.MajorTickPen = PlotterPen.Create(axis.TicklineColor, axis.MajorGridlineThickness);
        this.ZeroPen = PlotterPen.Create(axis.TicklineColor, axis.MajorGridlineThickness);
        this.ExtraPen = PlotterPen.Create(axis.ExtraGridlineColor, axis.ExtraGridlineThickness, axis.ExtraGridlineStyle);
        this.AxislinePen = PlotterPen.Create(axis.AxislineColor, axis.AxislineThickness, axis.AxislineStyle);
    }
