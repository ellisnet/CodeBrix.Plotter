...
public abstract class Axis : PlotElement
{
    ...
    protected Axis()
    {
        ...
        this.TicklineColor = PlotterColors.Black;
        this.MinorTicklineColor = PlotterColors.Automatic;

        this.AxislineStyle = LineStyle.None;
        this.AxislineColor = PlotterColors.Black;
        this.AxislineThickness = 1.0;

        this.MajorGridlineStyle = LineStyle.None;
        this.MajorGridlineColor = PlotterColor.FromArgb(0x40, 0, 0, 0);
        this.MajorGridlineThickness = 1;

        this.MinorGridlineStyle = LineStyle.None;
        this.MinorGridlineColor = PlotterColor.FromArgb(0x20, 0, 0, 0x00);
        this.MinorGridlineThickness = 1;

        this.ExtraGridlineStyle = LineStyle.Solid;
        this.ExtraGridlineColor = PlotterColors.Black;
        ...
        this.TitleColor = PlotterColors.Automatic;
    ...
    /// </summary>
    /// <remarks>
    /// The value is refreshed by <see cref="UpdateTransform(PlotterRect)"/>, which is called before any plot elements are rendered.
    /// </remarks>
    ...
    /// <summary>
    /// Gets or sets the color of the axis line. The default value is <see cref="PlotterColors.Black" />.
    /// </summary>
    public PlotterColor AxislineColor { get; set; }
    ...
    /// <summary>
    /// Gets or sets the color of the extra gridlines. The default value is <see cref="PlotterColors.Black"/>.
    /// </summary>
    public PlotterColor ExtraGridlineColor { get; set; }
    ...
    /// </summary>
    public PlotterColor MajorGridlineColor { get; set; }
    ...
    /// </summary>
    public PlotterColor MinorGridlineColor { get; set; }
    ...
    /// <summary>
    /// Gets or sets the color of the minor ticks. The default value is <see cref="PlotterColors.Automatic"/>.
    /// </summary>
    /// <remarks>If the value is <see cref="PlotterColors.Automatic"/>, the value of
    /// <see cref="Axis.TicklineColor"/> will be used.</remarks>
    public PlotterColor MinorTicklineColor { get; set; }
    ...
    /// <summary>
    /// Gets or sets the tick style for major and minor ticks. The default value is <see cref="CodeBrix.Plotter.Axes.TickStyle.Outside"/>.
    /// </summary>
    public TickStyle TickStyle { get; set; }

    /// <summary>
    /// Gets or sets the color of the major and minor ticks. The default value is <see cref="PlotterColors.Black"/>.
    /// </summary>
    public PlotterColor TicklineColor { get; set; }
    ...
    /// <summary>
    /// Gets or sets the color of the title. The default value is <see cref="PlotterColors.Automatic"/>.
    /// </summary>
    /// <remarks>If the value is <c>null</c>, the <see cref="PlotModel.TextColor" /> will be used.</remarks>
    public PlotterColor TitleColor { get; set; }
    ...
    /// </summary>
    public PlotterThickness DesiredMargin { get; protected set; }
    ...
    /// </summary>
    protected internal PlotterColor ActualTitleColor
    {
        get
        {
...
#pragma warning restore 1718
    ...
    public virtual void Measure(IRenderContext rc)
    {
        ...
        {
            this.DesiredMargin = new PlotterThickness(0);
            return;
        }

        this.GetTickValues(out var majorLabelValues, out _, out _);

        var maximumTextSize = new PlotterSize();
        ...
        this.DesiredMargin = new PlotterThickness(marginLeft, marginTop, marginRight, marginBottom);
    }
    ...
    internal virtual void UpdateIntervals(PlotterRect plotArea)
    {
    ...
    internal virtual void UpdateTransform(PlotterRect bounds)
    {
